...
export const ALIENTO_AIRE: Resumen = {
  ...
  partes: [
    {
      titulo: "Salida: una pantalla de escáner en mayo de 2013",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "El libro empieza con Paul Kalanithi mirando su propio escáner. Reconoce lo que está viendo porque lleva años leyendo imágenes iguales: los pulmones llenos de nódulos, la columna deformada, un lóbulo hepático borrado. No hace falta que nadie se lo explique. Ese primer párrafo dura media página.",
        },
        {
          forma: "texto",
          texto:
            "Lo que describe no es una sospecha sino una lectura. Sabe qué significan esos nódulos porque él mismo se los ha enseñado a decenas de familias, y en el mismo párrafo calcula el pronóstico sin necesidad de esperar a ningún informe. El diagnóstico se lo dio él mismo.",
        },
        {
          forma: "texto",
          texto:
            "La escena del escáner marca el tono de todo el libro. No hay suspense, no hay segunda opinión y no hay esperanza de error: el lector sabe desde la primera página cómo termina, y lo que queda por leer es cómo se ocupan los meses de en medio.",
        },
        {
          forma: "texto",
          texto:
            "Conviene precisar lo que el lector no va a encontrar. No hay lucha épica, no hay tratamientos milagrosos ni viajes pendientes: hay un hombre decidiendo si vuelve al quirófano, si escribe y cuánto tiempo pasa sentado con su mujer. Tampoco hay enemigos ni culpables en ninguna de sus páginas.",
        },
        {
          forma: "texto",
          texto:
            "Tenía treinta y seis años y no había fumado nunca. Le quedaban meses para terminar diez años de formación como neurocirujano en Stanford, tenía ofertas de trabajo encima de la mesa y llevaba semanas perdiendo peso y con dolor de espalda. Faltaban meses para su primer contrato.",
        },
        {
          forma: "texto",
          texto:
            "Los síntomas habían empezado meses antes y él los había explicado de otra manera. Dolor de espalda y pérdida de peso en alguien que trabaja cien horas semanales y duerme poco parecen agotamiento, y el primer médico al que consultó pensó lo mismo. Nadie pide un escáner con esa edad.",
        },
        {
          forma: "texto",
          texto:
            "La demora en el diagnóstico es habitual en estos casos. El cáncer de pulmón en personas jóvenes y no fumadoras suele detectarse tarde porque nadie lo busca, y cuando aparece suele hacerlo ya extendido a hueso, hígado o cerebro. En su caso ya había llegado a la columna vertebral.",
        },
        {
          forma: "texto",
          texto:
            "Los casos como el suyo han aumentado en las estadísticas. Una parte creciente de los diagnósticos de cáncer de pulmón corresponde a personas que nunca fumaron, sobre todo mujeres jóvenes, y las causas siguen sin estar claras. El humo ajeno y el radón explican solo una parte.",
        },
        {
          forma: "texto",
          texto:
            "El diagnóstico fue cáncer de pulmón en estadio cuatro. Un tumor con una mutación concreta que responde a un tratamiento dirigido, lo cual explica que pudiera volver al quirófano durante un tiempo y que el libro no sea la crónica de un derrumbe rápido. El estadio cuatro no tiene curación.",
        },
        {
          forma: "clave",
          rotulo: "La vuelta",
          frase: "Pasó de decidir cuánto le quedaba a otros a que alguien lo decidiera por él.",
        },
        {
          forma: "texto",
          texto:
            "El título viene de un poema del siglo diecisiete. Es un verso de Fulke Greville que dice que quien busque qué es la vida dentro de la muerte encontrará que es aire lo que antes fue aliento, y aparece como cita al principio del volumen.",
        },
        {
          forma: "arte",
          texto:
            "Greville fue un poeta y político isabelino, amigo de Philip Sidney, hoy casi olvidado fuera de las antologías. Kalanithi lo conocía por sus años de literatura inglesa, y el verso funciona como resumen del libro entero antes de que empiece. Escribió aquellos versos hacia 1600.",
          arte: "lectora",
        },
        {
          forma: "texto",
          texto:
            "La cita completa aparece antes del primer capítulo, en inglés antiguo. Kalanithi la eligió sabiendo que casi ningún lector la reconocería, y el editor mantuvo el título aunque en las reuniones se propusieron alternativas más comerciales. Los editores querían algo que se entendiera en la portada.",
        },
        {
          forma: "texto",
          texto:
            "El editor acertó al no tocarlo. Un título tomado de un poema del siglo diecisiete, en un libro de un neurocirujano moribundo, avisa desde la portada de que esto no va a ser un testimonio sanitario al uso. El título en inglés funciona igual de bien que el español.",
        },
        {
          forma: "texto",
          texto:
            "Kalanithi había nacido en Nueva York en 1977 y se crió en Kingman, un pueblo del desierto de Arizona al que su padre, cardiólogo, mudó a la familia. Su madre le puso a los doce años una lista de lecturas para preparar la universidad. Aquel pueblo tenía un solo instituto.",
        },
        {
          forma: "texto",
          texto:
            "De ahí sale una biografía poco habitual en un cirujano. Estudió literatura inglesa y biología humana en Stanford, hizo un máster en historia y filosofía de la ciencia en Cambridge y solo después entró en la facultad de medicina de Yale. Empezó medicina con veintiséis años cumplidos.",
        },
        {
          forma: "texto",
          texto:
            "Aquel recorrido tardó años y él lo defiende. Sostiene que la literatura le dio el vocabulario para pensar en el sentido y la neurociencia le dio el sustrato físico, y que quería ver los dos mirándose de cerca en la misma habitación. Nadie de su promoción venía de letras.",
        },
        {
          forma: "texto",
          texto:
            "Su tesis de máster en Cambridge trataba de historia y filosofía de la medicina. Volvió de Inglaterra convencido de que las preguntas que le interesaban no se responden leyendo, sino estando delante de alguien que se está muriendo. Volvió de Cambridge con veinticinco años y sin plaza asegurada.",
        },
        {
          forma: "texto",
          texto:
            "Ensayos, de Montaigne, que también está en este catálogo, hizo cuatro siglos antes un movimiento parecido. Montaigne decía que filosofar es aprender a morir y escribía desde su torre; Kalanithi lo intentó desde una camilla y con prisa. Montaigne tardó veinte años en escribir el suyo, sin ninguna urgencia.",
        },
        {
          forma: "texto",
          texto:
            "Su pregunta era siempre la misma y venía de los libros. Quería saber dónde se tocan la biología y el significado, qué hace que una vida valga la pena, y decidió que la medicina era el sitio donde esa pregunta se plantea de verdad. La respuesta no aparece en el libro.",
        },
        {
          forma: "texto",
          texto:
            "Conviene aclarar qué clase de libro es. No es un diario del enfermo ni un manual para afrontar nada: es una autobiografía escrita a toda prisa por alguien que sabía que no iba a poder revisarla, con la mitad dedicada a su vida anterior. El orden cronológico se respeta casi entero.",
        },
        {
          forma: "texto",
          texto:
            "Escribió el libro en unos veinte meses, mientras se trataba.",
        },
        {
          forma: "clave",
          rotulo: "El dato",
          frase: "Murió el 9 de marzo de 2015, a los treinta y siete años, sin terminarlo.",
        },
        {
          forma: "texto",
          texto:
            "Se publicó en enero de 2016 y llegó al número uno.",
        },
      ],
    },
    {
      titulo: "Primera parada: diez años aprendiendo a abrir cabezas",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "La primera mitad del libro cuenta la formación, y es la mejor. Kalanithi describe la residencia de neurocirugía como un oficio manual aprendido con las manos de otro encima de las suyas, con jornadas de más de cien horas semanales durante años. El tono cambia por completo después.",
        },
        {
          forma: "texto",
          texto:
            "La residencia de neurocirugía es la más larga de la medicina estadounidense. Son siete años después de la carrera, con guardias que encadenan treinta horas seguidas, y él añadió además un periodo de investigación en el laboratorio. Muy pocos de los que empiezan llegan hasta el final.",
        },
        {
          forma: "texto",
          texto:
            "El precio de esos años aparece contado sin heroísmo. Describe quedarse dormido de pie, comer en dos minutos, perder bodas y funerales, y una escena en la que un compañero de promoción se suicida y el hospital sigue funcionando al día siguiente. Aquel suicidio ocupa apenas un párrafo.",
        },
        {
          forma: "texto",
          texto:
            "Conviene precisar que el libro tampoco denuncia ese sistema. Describe la dureza de la residencia como parte del oficio, con orgullo incluso, y no se pregunta si hacen falta jornadas así para formar a un buen cirujano. La discusión sobre los horarios lleva años abierta en el gremio.",
        },
        {
          forma: "texto",
          texto:
            "Eligió esa especialidad por una razón concreta. El cerebro es el órgano donde vive la identidad, así que operarlo no es reparar una pieza: es negociar con una familia cuánta persona se puede perder a cambio de cuánto tiempo de vida. Ninguna otra cirugía plantea eso a diario.",
        },
        {
          forma: "texto",
          texto:
            "Su manera de decirlo es directa. Un cirujano de rodilla arregla una articulación y el paciente sigue siendo el mismo; un cirujano de cerebro puede devolver a la familia a alguien que ya no reconoce a nadie, y eso hay que decidirlo antes de entrar.",
        },
        {
          forma: "texto",
          texto:
            "De ahí sale el tipo de conversación que más le costaba. Explicar a unos padres que su hijo puede salir vivo del quirófano y no volver a hablar, y que la decisión es suya, exige un lenguaje que la facultad no enseña en ninguna asignatura.",
        },
        {
          forma: "texto",
          texto:
            "Su regla para esas conversaciones era sencilla y difícil. No dar toda la información de golpe, averiguar primero qué es lo que la familia teme perder, y colocar los datos alrededor de eso en vez de recitar un pronóstico completo. Sentarse era la mitad del procedimiento.",
        },
        {
          forma: "texto",
          texto:
            "Cuenta el caso de un tumor pegado al área del lenguaje. Se puede extirpar entero y dejar a alguien sin poder hablar nunca más, o dejar un margen y que el tumor vuelva antes, y esa decisión no la toma el bisturí. El paciente y su familia deciden solos.",
        },
        {
          forma: "clave",
          rotulo: "El oficio",
          frase: "La pregunta del quirófano no es qué se puede quitar, sino qué merece la pena conservar.",
        },
        {
          forma: "texto",
          texto:
            "También cuenta lo que la formación le hizo a él. Describe cómo aprendió a mirar un cadáver en primero de carrera con una distancia que le asustó, y cómo esa misma distancia, años después, le convertía en un técnico eficaz y en un mal acompañante.",
        },
        {
          forma: "texto",
          texto:
            "El capítulo de la sala de disección es el más duro de esa parte. Describe cómo un grupo de estudiantes de veintidós años pasa de la náusea a las bromas en cuestión de semanas, y cómo esa costra profesional es necesaria y a la vez peligrosa.",
        },
        {
          forma: "texto",
          texto:
            "Cuenta además un detalle que no se olvida. Años después conoció a la hija de una mujer cuyo cuerpo había disecado, y tuvo que decidir en ese momento qué contarle y qué callarse sobre lo que había hecho con las manos. Aquella conversación duró unos pocos minutos.",
        },
        {
          forma: "texto",
          texto:
            "Aquella escena resume su manera de escribir. Encuentra el momento incómodo, se queda dentro de él y no lo resuelve, que es exactamente lo contrario de lo que hace la mayoría de los libros escritos por médicos. Elige siempre el momento del que preferiría no acordarse.",
        },
        {
          forma: "texto",
          texto:
            "Hay una escena que resume esa corrección. Un residente da una noticia terrible de pie, deprisa, junto a una camilla, y su jefe le explica después que sentarse, callarse y aguantar el silencio forma parte del procedimiento igual que lavarse las manos. Aquel jefe llevaba treinta años operando.",
        },
        {
          forma: "texto",
          texto:
            "Su definición del oficio médico es la frase más citada del libro. Dice que el deber no es esquivar la muerte ni devolver al paciente su vida anterior, sino sostener a alguien cuya vida se ha desmontado hasta que pueda volver a mirarla de frente.",
        },
        {
          forma: "texto",
          texto:
            "Esa frase la escribió antes de enfermar. Aparece en la parte del libro dedicada a la residencia, y cuando el lector llega al segundo bloque descubre que el autor ha pasado a ser exactamente el paciente que describía en esas líneas. El lector lo descubre unas páginas después.",
        },
        {
          forma: "texto",
          texto:
            "Ese cambio de posición organiza el libro entero. La primera mitad está escrita por un médico que observa a los enfermos y la segunda por un enfermo que sigue pensando como médico, y las dos voces no acaban de encajar del todo. Los dos tonos se distinguen a simple vista.",
        },
        {
          forma: "texto",
          texto:
            "Hay quien considera que esa costura es el defecto del libro y quien la considera su tema. Las dos lecturas se sostienen, y la segunda parte es medible más corta: unas ochenta páginas frente a las ciento veinte de la primera. La proporción se nota mucho al leerlo.",
        },
        {
          forma: "texto",
          texto:
            "En paralelo hacía investigación de laboratorio. Trabajó en el equipo de Karl Deisseroth, en la técnica que permite encender neuronas concretas con luz, y en 2014 recibió el premio de investigación más importante de la academia estadounidense de su especialidad. Firmó varios artículos en revistas de neurociencia.",
        },
        {
          forma: "texto",
          texto:
            "Conviene precisar lo que ese currículo significa aquí. No aparece como presunción, sino como el material de la pérdida: el libro trata de un hombre a un año de cobrar todo aquello, al que se lo quitan justo antes. Nada de eso llegó a convertirse en una carrera.",
        },
        {
          forma: "texto",
          texto:
            "Volvió a operar durante meses mientras estaba en tratamiento.",
        },
        {
          forma: "texto",
          texto:
            "Terminó la residencia y dio el discurso de su promoción.",
        },
        {
          forma: "clave",
          rotulo: "El detalle",
          frase: "La última operación la hizo sabiendo que era la última.",
        },
      ],
    },
    {
      titulo: "Segunda parada: la curva que su oncóloga no quiso enseñarle",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "En la primera consulta pide lo que pediría cualquier médico. Quiere las cifras de supervivencia, las curvas, la mediana, algo con lo que planificar, y su oncóloga, Emma Hayward, se niega a darle un número por más que insista. Volvió a pedírselo en varias visitas y siempre le dijo no.",
        },
        {
          forma: "texto",
          texto:
            "Emma Hayward es un personaje real y aparece con su nombre. Kalanithi la describe como la única persona del hospital que no le trató como a un colega, y que insistió en tratarlo como a un paciente incluso cuando él se resistía. El nombre real aparece con su permiso.",
        },
        {
          forma: "texto",
          texto:
            "Su papel en el libro es casi el de una segunda protagonista. Le retira el papel de colega cada vez que él intenta discutir el tratamiento de igual a igual, y le repite que su trabajo ahora consiste en decidir qué quiere hacer con su vida.",
        },
        {
          forma: "texto",
          texto:
            "Ese enfoque tiene nombre en la profesión. Se llama tomar decisiones compartidas, y consiste en no soltar los datos y desaparecer, sino ayudar al paciente a elegir según lo que a él le importa, que es la parte que casi nunca se enseña. La facultad no dedica horas a eso.",
        },
        {
          forma: "texto",
          texto:
            "Su argumento es que el número no le serviría. Una mediana describe a un grupo grande y no dice nada sobre un caso concreto, y él estaba pidiendo una cifra no para entender su enfermedad sino para decidir qué hacer con el tiempo. La mediana describe a mil desconocidos.",
        },
        {
          forma: "texto",
          texto:
            "La conversación tiene una segunda capa que él entiende enseguida. Como médico había dado esas mismas cifras muchas veces, y solo desde la camilla se dio cuenta de que un número no es información, sino una manera de repartir la esperanza. Del otro lado se ve completamente distinto.",
        },
        {
          forma: "texto",
          texto:
            "Ahí está el hallazgo más útil del libro para cualquier lector. Lo que un enfermo pide cuando pide un número no es un dato, sino un permiso para hacer planes, y responder con una cifra falsa se lo quita en vez de dárselo. Nadie planifica nada con una probabilidad.",
        },
        {
          forma: "texto",
          texto:
            "Conviene precisar hasta dónde llega ese consejo. No dice que haya que ocultar información: dice que el médico debe averiguar para qué quieren el número antes de darlo, y que un dato dado sin esa pregunta previa suele hacer daño. El paciente decide qué quiere saber.",
        },
        {
          forma: "clave",
          rotulo: "El problema",
          frase: "Con diez años por delante haría una cosa; con diez meses, otra distinta.",
        },
        {
          forma: "texto",
          texto:
            "Esa negativa es el centro moral del libro. La oncóloga le está diciendo que no puede organizar su vida alrededor de una estadística, y que lo que tiene que hacer es decidir qué le importa y hacerlo, sin saber cuánto le queda. Es también el consejo más difícil de seguir.",
        },
        {
          forma: "texto",
          texto:
            "Conviene precisar de dónde salen esas curvas. Se llaman de Kaplan y Meier, dibujan qué proporción de pacientes sigue viva a cada altura del calendario y se calculan sobre grupos diagnosticados años antes, con tratamientos que ya han cambiado. Cualquier curva publicada retrata a enfermos de hace una década.",
        },
        {
          forma: "texto",
          texto:
            "Hay además un detalle estadístico que él conocía bien. Esas curvas tienen una cola larga a la derecha, con pacientes que viven mucho más que la mediana, y nadie puede saber de antemano en qué parte del dibujo va a caer uno. La media y la mediana tampoco coinciden.",
        },
        {
          forma: "texto",
          texto:
            "Esa cola larga es también un problema de comunicación. Decir que la mediana es de un año significa que la mitad vive menos y la otra mitad más, y casi todo el mundo lo entiende como una fecha de caducidad personal. Ningún médico puede decir dónde caerás tú.",
        },
        {
          forma: "texto",
          texto:
            "Stephen Jay Gould escribió sobre esto un ensayo célebre en 1985, cuando le diagnosticaron un tumor con ocho meses de mediana. Vivió veinte años más y dedicó aquel texto a explicar que una mediana no es un mensaje sobre uno mismo. Su ensayo se titulaba La mediana no es el mensaje.",
        },
        {
          forma: "texto",
          texto:
            "Su caso lo demuestra bien. La mutación que tenía su tumor respondía a una pastilla que llevaba pocos años disponible, así que cualquier estadística publicada antes de esa pastilla describía a un grupo de pacientes que no se parecía al suyo. Aquellas cifras eran de otra era terapéutica.",
        },
        {
          forma: "texto",
          texto:
            "Durante unos meses la respuesta fue buena. El escáner mejoró, volvió al quirófano, recuperó horarios imposibles y llegó a plantearse una carrera académica, y el libro cuenta con precisión lo raro que es vivir con una prórroga de duración desconocida. Llegó a operar catorce horas seguidas.",
        },
        {
          forma: "texto",
          texto:
            "El tratamiento que tomaba pertenece a una familia relativamente nueva. Son fármacos que bloquean una proteína concreta alterada en el tumor, funcionan solo si esa mutación está presente y suelen dejar de funcionar al cabo de un tiempo. El tumor acaba encontrando la manera de esquivar el bloqueo.",
        },
        {
          forma: "texto",
          texto:
            "Anticáncer, de Servan-Schreiber, que también está en este catálogo, viene del mismo sitio y llega a otra parte. Su autor era un médico con un tumor cerebral que escribió un libro de recomendaciones; Kalanithi no recomienda absolutamente nada. Aquel autor vivió diecinueve años con su tumor cerebral.",
        },
        {
          forma: "texto",
          texto:
            "La diferencia entre los dos libros es de género y de honradez. Uno promete que ciertos hábitos ayudan y el otro se limita a contar lo que pasó, y con el tiempo el segundo ha envejecido mucho mejor que el primero. Las promesas caducan y los relatos no.",
        },
        {
          forma: "texto",
          texto:
            "Después el tumor volvió y hubo que pasar a la quimioterapia. Ahí es donde el texto se vuelve más corto y más entrecortado, en parte porque escribía con guantes por la neuropatía de las manos y con muy pocas horas buenas al día. La segunda parte del libro es notablemente más corta.",
        },
        {
          forma: "texto",
          texto:
            "También conviene decir lo que el libro no hace. No presenta la enfermedad como una lección, no cuenta que le enseñara a valorar lo importante y no ofrece ninguna reconciliación: dice varias veces que lo que le está pasando no tiene sentido. La palabra lucha no aparece nunca.",
        },
        {
          forma: "texto",
          texto:
            "La pastilla que tomaba se toma una vez al día por la boca.",
        },
        {
          forma: "clave",
          rotulo: "La cifra",
          frase: "Nadie llegó a decirle nunca cuántos meses le quedaban.",
        },
        {
          forma: "texto",
          texto:
            "Ese silencio resultó ser la respuesta más honesta.",
        },
      ],
    },
    {
      titulo: "Tercera parada: una niña nacida con el reloj en contra",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "En algún momento del tratamiento, Paul y su mujer, Lucy, deciden tener un hijo. Ella es médica internista, sabe exactamente lo que va a pasar, y la conversación que reproducen en el libro es la más incómoda y la más clara de todas. La escena ocupa poco más de una página.",
        },
        {
          forma: "texto",
          texto:
            "La conversación ocurre con las dos carreras médicas encima de la mesa. Ninguno de los dos necesita que le expliquen los plazos ni las probabilidades, así que discuten directamente lo que casi nadie discute en voz alta con esa claridad. Ninguno de los dos necesitaba folletos.",
        },
        {
          forma: "texto",
          texto:
            "La fecundación in vitro añadía otra capa de cálculo. Había que congelar antes de empezar la quimioterapia, sin saber si el tratamiento iba a funcionar, de modo que la decisión de tener una hija se tomó en la peor semana posible para tomarla. Aquella semana empezaba también la quimioterapia.",
        },
        {
          forma: "texto",
          texto:
            "El libro no presenta esa decisión como valiente. La cuenta como lo que fue, una elección discutible tomada entre dos personas agotadas, y deja constancia de que hubo gente cercana que pensó que era una mala idea. Tampoco cuenta qué opinaban los médicos que la trataron a ella.",
        },
        {
          forma: "texto",
          texto:
            "Lucy pregunta si no le hará más difícil morirse. Él responde que sí, que probablemente sí, y a continuación dice la frase que cierra la discusión: y no sería precioso que así fuera, que morirse siga doliendo porque hay algo que perder. Ella recordaba esa respuesta palabra por palabra.",
        },
        {
          forma: "texto",
          texto:
            "Esa respuesta es la frase que más se cita del libro después de la del oficio médico. Su lógica es que una vida que duele al perderse es la prueba de que valía algo, y que anestesiarse por adelantado sería perderla dos veces. El argumento es antiguo y suena nuevo.",
        },
        {
          forma: "texto",
          texto:
            "El razonamiento tiene detrás sus años de literatura. Kalanithi había escrito sobre la relación entre finitud y sentido mucho antes de enfermar, y cuando le tocó vivirlo aplicó la misma idea sin cambiarle una coma. Aquellos años de literatura acabaron sirviéndole para algo muy concreto.",
        },
        {
          forma: "texto",
          texto:
            "Conviene precisar lo que esa frase no significa. No dice que el sufrimiento tenga un premio ni que morir joven tenga sentido: dice que quitarse cosas para que duela menos al final es una manera de perderlas antes de tiempo. Tampoco recomienda a nadie hacer lo mismo.",
        },
        {
          forma: "clave",
          rotulo: "La decisión",
          frase: "Congelaron esperma antes del tratamiento porque la quimioterapia deja estéril.",
        },
        {
          forma: "texto",
          texto:
            "Cady nació en julio de 2014 por fecundación in vitro. Paul llegó a la sala de partos en silla de ruedas, con una manta encima, y la sostuvo en brazos aquel mismo día; vivió con ella ocho meses, que es lo que le quedaba. Nunca llegó a llevarla al parque.",
        },
        {
          forma: "texto",
          texto:
            "El nombre completo de la niña es Elizabeth Acadia. Nació en el mismo hospital donde su padre había operado durante años, y varios de los médicos que atendieron el parto eran compañeros suyos de residencia. Sus padres lo eligieron pensando en un lugar concreto y lejano.",
        },
        {
          forma: "texto",
          texto:
            "Las fotografías de aquellos ocho meses aparecen en las ediciones ilustradas y en las charlas que su mujer da desde entonces. En casi todas él está sentado, con la niña encima, porque ya no podía sostenerla de pie mucho rato. Casi todas están tomadas dentro de casa.",
        },
        {
          forma: "texto",
          texto:
            "Lucy Kalanithi ha convertido esa experiencia en trabajo público. Da conferencias sobre cuidados al final de la vida, defiende que se hable de la muerte en las consultas y firmó el epílogo sabiendo que iba a leerlo mucha más gente que a ella. Su charla más vista pasa del millón.",
        },
        {
          forma: "texto",
          texto:
            "Las últimas líneas que escribió van dirigidas a ella. Le dice que si en el futuro tiene que contar su vida, no se olvide de mencionar que llenó de una alegría desmesurada los días de un hombre que se estaba muriendo. Después de eso no escribió nada más.",
        },
        {
          forma: "texto",
          texto:
            "El matrimonio no estaba bien cuando llegó el diagnóstico. El libro lo cuenta sin adornos: llevaban meses discutiendo, Lucy se planteaba separarse por el ritmo de la residencia, y la enfermedad interrumpió esa conversación y la sustituyó por otra. Ese párrafo desarma cualquier lectura sentimental del resto.",
        },
        {
          forma: "texto",
          texto:
            "Lucy lo cuenta también en el epílogo y no lo suaviza. Habían empezado terapia de pareja, dormían en habitaciones distintas y ella había pensado en marcharse unas semanas antes de que llegara el resultado del escáner. Habían llegado a pedir cita con un abogado para informarse.",
        },
        {
          forma: "texto",
          texto:
            "Ese material lo publicó ella siendo consciente de lo que hacía. Ha explicado en entrevistas que dejarlo fuera habría convertido el libro en una versión limpia y falsa, y que Paul había escrito esas páginas queriendo que se leyeran. Ninguna de las dos familias pidió que se retirara nada.",
        },
        {
          forma: "texto",
          texto:
            "De ahí sale también la parte más incómoda del éxito del libro. Una historia privada, escrita a medias y terminada por la viuda, se convirtió en un producto global, y la familia ha tenido que administrar esa exposición durante años. Nadie de la familia había buscado esa exposición.",
        },
        {
          forma: "texto",
          texto:
            "Ese detalle es el que hace creíble todo lo demás. Un libro que hubiera presentado un matrimonio perfecto se leería como una postal; este cuenta que estaban mal, que se arreglaron por una razón atroz y que a la vez fue verdad. Los libros de enfermos suelen quitar eso.",
        },
        {
          forma: "texto",
          texto:
            "La escena final la escribió Lucy en el epílogo. Describe la última tarde en el hospital, la decisión de retirar la ventilación y el momento en que él pidió que le pasaran a la niña una vez más antes de sedarlo. Duró unas pocas horas de aquella tarde.",
        },
        {
          forma: "texto",
          texto:
            "Conviene precisar quién termina el libro. Paul murió con el manuscrito a medias, sin conclusión y sin revisar, y todo lo que hay después de su última frase lo escribió su viuda a partir de lo que él le había contado. El epílogo son unas veinte páginas.",
        },
        {
          forma: "texto",
          texto:
            "Cady tenía ocho meses cuando murió su padre.",
        },
        {
          forma: "texto",
          texto:
            "Lucy Kalanithi sigue ejerciendo como internista en Stanford.",
        },
        {
          forma: "clave",
          rotulo: "Para quién",
          frase: "El libro está dedicado a una niña que no llegará a recordarlo.",
        },
      ],
    },
    {
      titulo: "Destino: un libro que se queda sin final",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "El texto no termina: se detiene. Kalanithi tenía planeada una tercera parte y no llegó a escribirla, así que el volumen pasa de sus últimas páginas al epílogo de Lucy sin ninguna transición, y esa costura se nota al leerlo. Ninguna edición ha intentado completarlo.",
        },
        {
          forma: "texto",
          texto:
            "El propio autor sabía que iba a quedarse corto. Escribió a un ritmo que sus editores describieron después como frenético, con la esperanza de llegar al final, y en los últimos meses ya solo podía trabajar en tramos de una hora. Trabajaba en los ratos sin dolor.",
        },
        {
          forma: "texto",
          texto:
            "Los editores contaron después cómo trabajaba. Escribía en un sillón reclinable, con guantes puestos por los efectos de la quimioterapia en las manos, y mandaba fragmentos por correo sin orden, confiando en que alguien los montaría. El texto llegó en fragmentos, por correo y sin numerar.",
        },
        {
          forma: "texto",
          texto:
            "El manuscrito llegó a la editorial en ese estado. Lo ordenaron respetando lo que había, sin añadir texto ni completar frases, y esa decisión editorial es la razón de que el libro tenga el final abrupto que tiene. Respetar ese estado fue una decisión discutida dentro de la casa.",
        },
        {
          forma: "texto",
          texto:
            "Mucha gente lo lee esperando serenidad y no la encuentra. No hay etapas ordenadas, ni aceptación final, ni un momento de paz: hay un hombre que quiere seguir operando, que se enfada, que cambia de plan tres veces y que se queda sin tiempo. El libro tampoco pretende consolar.",
        },
        {
          forma: "texto",
          texto:
            "Él mismo desconfiaba de esa clase de relato. En el texto se burla de la idea de que la enfermedad venga a enseñar algo, y dice que el cáncer no le convirtió en mejor persona sino en una persona con cáncer. La frase es suya y es literal.",
        },
        {
          forma: "texto",
          texto:
            "Esa desconfianza es lo que separa este libro de casi todo lo que se publica en su estantería. No hay lista de aprendizajes, no hay consejos y no hay un capítulo final que ate los cabos, porque el autor no llegó a atarlos. Ninguna editorial le pidió que lo cerrara.",
        },
        {
          forma: "texto",
          texto:
            "Ahí está a la vez su mérito y su límite. Es un libro honesto y corto que no intenta consolar a nadie, y quien lo abra buscando instrucciones para acompañar a un enfermo va a salir conmovido y con las manos vacías. El propio autor lo habría admitido.",
        },
        {
          forma: "texto",
          texto:
            "Conviene también señalar el punto ciego del libro. Kalanithi enfermó siendo médico en un hospital de élite, con seguro, con colegas que eran sus amigos y con acceso inmediato a lo mejor disponible, y el texto no se pregunta en ningún momento por eso. Ni una línea sobre facturas ni seguros.",
        },
        {
          forma: "texto",
          texto:
            "La lista de privilegios es larga y conviene tenerla presente. Padre cardiólogo, formación en Stanford, Cambridge y Yale, seguro médico de la universidad, mujer médica y una oncóloga que era su compañera de hospital antes de ser su doctora. Casi nadie que reciba ese diagnóstico tiene ninguna de esas cosas.",
        },
        {
          forma: "texto",
          texto:
            "Decirlo no es un reproche personal, es una advertencia de lectura. Este libro describe morir con todo a favor, y por eso no sirve como retrato de lo que le ocurre a la mayoría de la gente cuando recibe el mismo diagnóstico. El propio texto no lo pretendía nunca.",
        },
        {
          forma: "texto",
          texto:
            "La comparación con Séneca aclara ese punto. El estoico escribe sobre la brevedad de la vida con salud, patrimonio y tiempo por delante, y aquí el autor escribe con lo contrario, aunque tampoco desde la escasez material. Séneca era además uno de los hombres más ricos de Roma.",
        },
        {
          forma: "texto",
          texto:
            "Esa omisión no es un descuido menor. En el mismo país y en los mismos años, un diagnóstico así arruinaba a familias enteras, y el libro más leído sobre morir de cáncer no dedica una línea a lo que cuesta morirse. El precio medio de un tratamiento así es enorme.",
        },
        {
          forma: "texto",
          texto:
            "Ser mortal, de Atul Gawande, que también está en este catálogo, cubre justo ese hueco. Gawande es cirujano y escribe sobre el sistema: residencias, geriátricos, cuidados paliativos y las conversaciones que los médicos no saben tener con los moribundos. Gawande escribe además desde la salud y con tiempo por delante.",
        },
        {
          forma: "texto",
          texto:
            "Gawande publicó el suyo en 2014, dos años antes, y con un enfoque casi opuesto. Su libro está lleno de datos, de casos ajenos y de propuestas concretas sobre cómo debería cambiar la manera en que un sistema sanitario acompaña el final. Ninguno de los dos se pisa con el otro.",
        },
        {
          forma: "texto",
          texto:
            "El hombre en busca de sentido, de Frankl, que anda por este catálogo, es el otro pariente evidente. Frankl sostiene que el sentido se encuentra incluso en lo peor; Kalanithi lo busca durante doscientas páginas y no dice haberlo encontrado. Frankl salió vivo de aquello y él no.",
        },
        {
          forma: "texto",
          texto:
            "Ahí termina el viaje que empezó delante de una pantalla en Stanford. Un hombre que se pasó diez años decidiendo cuánto le quedaba a otros escribió doscientas páginas sobre no saber cuánto le quedaba a él, y se quedó sin terminarlas. El manuscrito se detiene a media frase.",
        },
        {
          forma: "texto",
          texto:
            "Los dos libros se leen bien seguidos y en ese orden. Gawande explica cómo está montada la maquinaria de morir en un país rico; Kalanithi cuenta qué se siente estando dentro de ella y sabiendo exactamente cómo funciona. Juntos ocupan una tarde larga de lectura.",
        },
        {
          forma: "texto",
          texto:
            "Con Séneca y con Marco Aurelio, que andan por aquí, la distancia es mayor. Los dos estoicos escriben sobre la muerte como ejercicio mental de gente sana; Kalanithi escribe con la enfermedad encima y sin la calma que ellos recomiendan. Los dos escribían para convencer a otros.",
        },
        {
          forma: "texto",
          texto:
            "El libro nació de dos artículos de periódico. Uno se publicó en el New York Times a comienzos de 2014, preguntando cuánto tiempo le quedaba, y el otro en la revista de la facultad de Stanford, ya con la niña nacida. Los dos textos se pueden leer todavía.",
        },
        {
          forma: "texto",
          texto:
            "Lo que queda es un texto breve, incompleto y sin moraleja. Sirve para entender qué se le pide a un médico cuando ya no hay nada que arreglar, y para ver a alguien intentando decidir qué hacer con un tiempo que no puede medir. Se lee en tres o cuatro horas.",
        },
        {
          forma: "texto",
          texto:
            "Fue finalista del Pulitzer de biografía en 2017.",
        },
        {
          forma: "clave",
          rotulo: "Para llevarte",
          frase: "Nadie te va a decir cuánto queda, así que la pregunta útil es qué harías igualmente.",
        },
        {
          forma: "texto",
          texto:
            "Ha vendido varios millones de ejemplares en cuarenta idiomas.",
        },
      ],
    },
  ],

...
import { CUBIERTAS_PROPIAS } from "./cubiertas";
...
const PORTADAS_COMMONS: Record<string, Foto> = {
  "moby-dick": {
...
/* Las cuatro cubiertas de Pablo mandan sobre lo que hubiera aquí para esos
   libros: son obra suya, hechas para esta app, y ganan a cualquier cuadro
   prestado de Commons por bien elegido que estuviera. */

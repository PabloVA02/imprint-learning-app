...
import { GEN_EGOISTA, FEYNMAN, VIDA_ARBOLES, CASI_TODO, MUNDO_DEMONIOS, EL_GEN, EINSTEIN, ASTROFISICA_PRISA, ULTIMOS_DINOSAURIOS, UNIVERSO_CASCARA, MUSICA_PRIMOS, UNIVERSO_MANO, ORIGEN_ESPECIES, HENRIETTA_LACKS, DOBLE_HELICE } from "./ciencia";

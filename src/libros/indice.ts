...
import { ANA_FRANK, ARMAS_GERMENES, INFINITO_JUNCO, MANDELA, MALALA, HOMO_DEUS, MUNDO_AYER, SPQR, PILARES_TIERRA } from "./historia";
import { GEN_EGOISTA, FEYNMAN, VIDA_ARBOLES, CASI_TODO, MUNDO_DEMONIOS, EL_GEN, EINSTEIN, ASTROFISICA_PRISA } from "./ciencia";

...
import { CUERPO_CUENTA, DIGESTION, NACIDOS_CORRER, DILEMA_OMNIVORO, ALIENTO_AIRE, ZONAS_AZULES, OUTLIVE, COME_COMIDA_REAL, INVICTO, MILAGRO_MANANA, SER_MORTAL } from "./salud";

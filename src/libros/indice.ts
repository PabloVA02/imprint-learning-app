...
import { ORGULLO_PREJUICIO, GUARDIAN_CENTENO, PEDRO_PARAMO, MOBY_DICK, MADAME_BOVARY, MONTECRISTO, BERNARDA_ALBA, ANA_KARENINA, RAYUELA, EL_TUNEL, RENGLONES_TORCIDOS } from "./literatura";

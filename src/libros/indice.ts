...
import { ARTE_GUERRA, ETICA_AMADOR, TAO_TE_CHING, ENQUIRIDION, MONJE_FERRARI, MUNDO_SOFIA, APOLOGIA_SOCRATES, SEGUNDO_SEXO, DISCURSO_METODO, ETICA_NICOMACO } from "./filosofia";

...
export const META: FichaMeta[] = [
  ...
  },
  {
    ...
    porQue: "Es el libro que pregunta si merece la pena seguir cuando nada garantiza que sí, y contesta que sí sin apoyarse en ningún consuelo.",
    minutos: 25.3,
    capitulos: [
      { titulo: "Salida: un piso de Orán en febrero de 1941", minutos: 5.1 },
      { titulo: "Primera parada: el día en que se cae el decorado", minutos: 5.1 },
      { titulo: "Segunda parada: los dos saltos que se niega a dar", minutos: 5 },
      { titulo: "Tercera parada: cuatro maneras de agotar lo posible", minutos: 5 },
      { titulo: "Destino: la piedra, y el rato de bajar", minutos: 5.1 },
    ],
  },
  {
    id: "cuatro-acuerdos",
  ...
  },
  {
    ...
    porQue: "Es el manual de desarrollo personal más vendido de la historia, y sus siete reglas siguen siendo difíciles de rebatir aunque el libro no demuestre ninguna.",
    minutos: 25.5,
    capitulos: [
      { titulo: "Salida: doscientos años de libros sobre el éxito", minutos: 5 },
      { titulo: "Primera parada: los tres primeros, la victoria privada", minutos: 5.2 },
      { titulo: "Segunda parada: los tres siguientes, la victoria pública", minutos: 5.1 },
      { titulo: "Tercera parada: lo que se le atribuye mal y donde falla", minutos: 5.1 },
      { titulo: "Destino: afilar la sierra", minutos: 5.1 },
    ],
  },
  {
    id: "amigos-influir",
  ...
  },
  {
    ...
    porQue: "Demuestra con datos que el mundo está mejor de lo que crees, explica por qué te parece lo contrario y avisa de las cinco cosas que sí son graves.",
    minutos: 25.4,
    capitulos: [
      { titulo: "Salida: trece preguntas y un chimpancé", minutos: 5.1 },
      { titulo: "Primera parada: cuatro niveles en vez de dos mundos", minutos: 5 },
      { titulo: "Segunda parada: diez instintos que deforman la vista", minutos: 5.2 },
      { titulo: "Tercera parada: lo que no dice y donde falla", minutos: 5 },
      { titulo: "Destino: los cinco riesgos que sí le quitaban el sueño", minutos: 5.1 },
    ],
  },
  {
    id: "semana-4-horas",

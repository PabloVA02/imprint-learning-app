...
export const META: FichaMeta[] = [
  ...
  },
  {
    ...
    porQue: "Un psiquiatra vienés observando el campo desde dentro, como preso y como científico a la vez. No hay otro libro igual.",
    minutos: 25.5,
    capitulos: [
      { titulo: "Salida: un trozo de mármol encima de la mesa", minutos: 5 },
      { titulo: "Primera parada: las tres fases del preso", minutos: 5.1 },
      { titulo: "Segunda parada: la logoterapia en pocas páginas", minutos: 5.2 },
      { titulo: "Tercera parada: lo que no dice y donde se le discute", minutos: 5.1 },
      { titulo: "Destino: la última de las libertades", minutos: 5.1 },
    ],
  },
  {
    id: "arte-guerra",

...
export const META: FichaMeta[] = [
  ...
  },
  {
    ...
    porQue: "Diez millones de ejemplares y cabe en una servilleta. Es el ejemplo perfecto de que una idea simple bien dicha vale más que cien páginas de matices.",
    minutos: 4,
    capitulos: [
      { titulo: "La domesticación", minutos: 0.7 },
      { titulo: "Los cuatro", minutos: 0.9 },
      { titulo: "Cómo se rompe un acuerdo viejo", minutos: 1.3 },
      { titulo: "Por qué funciona", minutos: 1.1 },
    ],
  },
  {
    id: "enquiridion",

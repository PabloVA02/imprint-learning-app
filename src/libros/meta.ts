...
export const META: FichaMeta[] = [
  ...
  },
  {
    ...
    porQue: "Es la respuesta más vendida contra el positivismo obligatorio, y su argumento central es más serio de lo que sugiere el título.",
    minutos: 4,
    capitulos: [
      { titulo: "Contra el pensar en positivo", minutos: 0.7 },
      { titulo: "Elegir qué te importa", minutos: 0.9 },
      { titulo: "Hitler tenía autoestima", minutos: 1.3 },
      { titulo: "Los valores de mierda", minutos: 1.1 },
    ],
  },
  {
    id: "etica-amador",

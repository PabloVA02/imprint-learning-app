...
export const META: FichaMeta[] = [
  ...
  },
  {
    ...
    porQue: "Dos españoles fueron a la aldea más longeva del mundo a preguntar por qué. Lo que trajeron es más práctico y menos místico de lo que sugiere la portada.",
    minutos: 4,
    capitulos: [
      { titulo: "Ogimi", minutos: 0.7 },
      { titulo: "Lo que hacen distinto", minutos: 0.6 },
      { titulo: "Fluir, y no parar nunca", minutos: 1.4 },
      { titulo: "El diagrama que no es japonés", minutos: 1.3 },
    ],
  },
  {
    id: "monje-ferrari",

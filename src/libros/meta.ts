...
export const META: FichaMeta[] = [
  ...
  },
  {
    ...
    autor: "George Orwell",
    ano: 1949,
    gancho: "Lo escribió tuberculoso en una isla sin electricidad, mecanografiando él mismo el original en la cama porque nadie quiso ir hasta allí.",
    porQue: "Se cita constantemente y casi siempre mal. La novela no advierte contra las cámaras: advierte contra algo bastante peor y mucho menos cómodo.",
    minutos: 25.4,
    capitulos: [
      { titulo: "Salida: una granja sin luz en una isla escocesa", minutos: 5.1 },
      { titulo: "Primera parada: el ministerio donde se reescribe el pasado", minutos: 5 },
      { titulo: "Segunda parada: la neolengua y el doblepensar", minutos: 5.1 },
      { titulo: "Tercera parada: lo que la novela no dice", minutos: 5.1 },
      { titulo: "Destino: la habitación 101 y el apéndice", minutos: 5.1 },
    ],
  },
  {
    id: "rebelion-granja",

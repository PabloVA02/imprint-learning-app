...
export const META: FichaMeta[] = [
  {
    ...
    capitulos: [
      ...
      { titulo: "Primera parada: creer en cosas que no existen", minutos: 5 },
      { titulo: "Segunda parada: el mayor fraude de la historia", minutos: 5.1 },
      { titulo: "Tercera parada: donde falla y qué no dice", minutos: 5.1 },
      { titulo: "Destino: la pregunta por la felicidad", minutos: 5.1 },
    ],
  },
  {
    id: "homo-deus",

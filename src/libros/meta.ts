...
export const META: FichaMeta[] = [
  ...
  },
  {
    ...
    porQue: "Es el libro de finanzas personales más vendido del mundo y el que peor fama tiene entre los expertos. Merece leerse por una idea que sí acertó, y con las advertencias puestas.",
    minutos: 4,
    capitulos: [
      { titulo: "Dos padres", minutos: 0.6 },
      { titulo: "Activos y pasivos", minutos: 0.9 },
      { titulo: "El cuadrante y el miedo", minutos: 1.3 },
      { titulo: "Las advertencias", minutos: 1.2 },
    ],
  },
  {

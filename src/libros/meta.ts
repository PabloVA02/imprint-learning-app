...
export const META: FichaMeta[] = [
  ...
  },
  {
    ...
    porQue: "Es el abuelo de toda la literatura de autoayuda: casi todo lo que has oído sobre mentalidad y objetivos sale de aquí. Conviene saber también qué parte es leyenda.",
    minutos: 4,
    capitulos: [
      { titulo: "El encargo", minutos: 0.6 },
      { titulo: "Deseo, fe y plan", minutos: 1 },
      { titulo: "Persistencia y decisión", minutos: 1.4 },
      { titulo: "El límite", minutos: 1.1 },
    ],
  },
  {
    id: "mente-millonaria",

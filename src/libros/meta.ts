...
export const META: FichaMeta[] = [
  ...
  },
  {
    ...
    porQue: "Cuenta tres mil años de historia de los libros como si fuera una novela de aventuras, y hace que te den ganas de leer más.",
    minutos: 4.1,
    capitulos: [
      { titulo: "Los cazadores de libros", minutos: 0.8 },
      { titulo: "De qué está hecho un libro", minutos: 1 },
      { titulo: "Quién podía leer", minutos: 1 },
      { titulo: "Por qué vendió tanto", minutos: 1.3 },
    ],
  },
  {
    id: "mundo-ayer",
  ...
  },
  {
    ...
    porQue: "Es la explicación en primera persona de cómo alguien sale de veintisiete años de prisión sin sed de venganza, y por qué eso fue una estrategia y no santidad.",
    minutos: 4,
    capitulos: [
      { titulo: "El manuscrito enterrado", minutos: 0.9 },
      { titulo: "El abogado que se hizo saboteador", minutos: 0.8 },
      { titulo: "Robben", minutos: 0.9 },
      { titulo: "Salir sin rencor", minutos: 1.4 },
    ],
  },
  {
    id: "tatuador",
  ...
  },
  {
    ...
    porQue: "Explica cómo un valle turístico de Pakistán se convirtió en un sitio donde volaban escuelas, contado por alguien que lo vivió con once años.",
    minutos: 4,
    capitulos: [
      { titulo: "El valle", minutos: 0.9 },
      { titulo: "Gul Makai", minutos: 0.9 },
      { titulo: "9 de octubre de 2012", minutos: 0.8 },
      { titulo: "Lo que el libro sí y lo que no", minutos: 1.4 },
    ],
  },
  {
    id: "si-esto-hombre",
  ...
  },
  {
    ...
    autor: "Marco Aurelio",
    ano: 180,
    gancho: "El hombre más poderoso del mundo escribiendo, de noche, para convencerse a sí mismo.",
    porQue: "No fue escrito para ti. Es el cuaderno privado de un emperador que se daba órdenes a sí mismo, y por eso no tiene una sola frase de adorno.",
    minutos: 4.2,
    capitulos: [
      { titulo: "Un cuaderno que no era para nadie", minutos: 1 },
      { titulo: "Lo que depende de ti", minutos: 1 },
      { titulo: "La gente insoportable", minutos: 0.7 },
      { titulo: "La vista desde arriba", minutos: 0.9 },
      { titulo: "Lo que el libro no resuelve", minutos: 0.7 },
    ],
  },
  {
    id: "busca-sentido",
  ...
  },
  {
    ...
    porQue: "Cien páginas que fundaron la ciencia política y que llevan cinco siglos citándose mal. Su fama de manual de villanos es injusta.",
    minutos: 4.1,
    capitulos: [
      { titulo: "Escrito desde el destierro", minutos: 0.8 },
      { titulo: "Cómo son las cosas", minutos: 1 },
      { titulo: "El zorro y el león", minutos: 0.9 },
      { titulo: "El malentendido", minutos: 1.3 },
    ],
  },
  {
    id: "zaratustra",
  ...
  },
  {
    ...
    porQue: "Treinta páginas del estoico más práctico. Es el mejor antídoto que existe contra la sensación de que la vida se te está yendo.",
    minutos: 4.1,
    capitulos: [
      { titulo: "La queja de siempre", minutos: 0.8 },
      { titulo: "Los ocupados", minutos: 0.9 },
      { titulo: "Los tres tiempos", minutos: 0.9 },
      { titulo: "El autor incómodo", minutos: 1.5 },
    ],
  },
  {
    id: "sisifo",
  ...
  },
  {
    ...
    porQue: "Diez millones de ejemplares y un récord de nueve meses en las listas. Es el intento más logrado de contar la física moderna a alguien que no sabe física.",
    minutos: 4,
    capitulos: [
      { titulo: "La tortuga", minutos: 0.6 },
      { titulo: "El tiempo no es lo que crees", minutos: 1 },
      { titulo: "Las flechas del tiempo", minutos: 1.4 },
      { titulo: "El principio", minutos: 1 },
    ],
  },
  {
    id: "cosmos",
  ...
  },
  {
    ...
    porQue: "Cambió el punto de vista de toda la biología con un solo giro de perspectiva, y de paso inventó la palabra «meme».",
    minutos: 4,
    capitulos: [
      { titulo: "El cambio de punto de vista", minutos: 0.8 },
      { titulo: "Por qué existe la generosidad", minutos: 0.9 },
      { titulo: "Los memes", minutos: 1 },
      { titulo: "Lo que se le critica", minutos: 1.3 },
    ],
  },
  {
    id: "universo-cascara",
  ...
  },
  {
    ...
    porQue: "Cuenta toda la ciencia desde el Big Bang hasta el ser humano contando las peleas, los celos y las chapuzas de los científicos.",
    minutos: 4,
    capitulos: [
      { titulo: "La pregunta del avión", minutos: 0.8 },
      { titulo: "Los científicos que nadie cuenta", minutos: 1.1 },
      { titulo: "Lo pequeño y lo enorme", minutos: 0.8 },
      { titulo: "Lo bueno y lo flojo", minutos: 1.2 },
    ],
  },
  {
    id: "mundo-demonios",
    ...
    porQue: "Contiene el mejor manual que existe para no dejarse engañar, escrito treinta años antes de que hiciera tanta falta.",
    minutos: 4.1,
    capitulos: [
      { titulo: "El taxista", minutos: 0.9 },
      { titulo: "El dragón del garaje", minutos: 0.9 },
      { titulo: "El detector de camelos", minutos: 1.1 },
      { titulo: "La profecía", minutos: 1.3 },
    ],
  },
  {
  ...
  },
  {
    ...
    porQue: "Un guarda forestal con treinta años de bosque explica que los árboles se comunican, y lo hace sin una sola palabra técnica.",
    minutos: 4,
    capitulos: [
      { titulo: "El tocón que no moría", minutos: 0.8 },
      { titulo: "La red bajo el suelo", minutos: 0.9 },
      { titulo: "El tiempo de los árboles", minutos: 0.9 },
      { titulo: "Dónde se le va la mano", minutos: 1.3 },
    ],
  },
  {
    id: "gen-historia",
  ...
  },
  {
    ...
    porQue: "Después de leerlo no puedes volver a ver un anuncio igual. Es el libro que más ha influido en cómo entendemos la publicidad.",
    minutos: 4,
    capitulos: [
      { titulo: "Ver es anterior a las palabras", minutos: 0.9 },
      { titulo: "Los hombres actúan, las mujeres aparecen", minutos: 0.8 },
      { titulo: "Pintar lo que se posee", minutos: 0.9 },
      { titulo: "La publicidad como heredera", minutos: 1.4 },
    ],
  },
  {
    id: "acto-creativo",
  ...
  },
  {
    ...
    porQue: "Desmonta en diez reglas cortas el mito que más gente paraliza: que hay que tener una idea original antes de empezar.",
    minutos: 4.1,
    capitulos: [
      { titulo: "Nada es original", minutos: 1.1 },
      { titulo: "Empieza antes de saber quién eres", minutos: 0.9 },
      { titulo: "Aburrido por fuera", minutos: 0.8 },
      { titulo: "La creatividad es restar", minutos: 1.3 },
    ],
  },
  {
    id: "camino-artista",
  ...
  },
  {
    ...
    porQue: "Reconstruye al personaje a partir de siete mil doscientas páginas de sus cuadernos. Y su conclusión es que el genio era, sobre todo, curiosidad entrenada.",
    minutos: 4,
    capitulos: [
      { titulo: "Las listas de tareas", minutos: 0.8 },
      { titulo: "Hombre sin letras", minutos: 1 },
      { titulo: "La sonrisa y el corazón", minutos: 0.8 },
      { titulo: "El que no terminaba", minutos: 1.3 },
    ],
  },
  {
    id: "arte-sin-hombres",
  ...
  },
  {
    ...
    porQue: "Es el libro que más escritores, músicos y deportistas regalan. Su idea central explica la procrastinación mejor que cualquier manual de productividad.",
    minutos: 4,
    capitulos: [
      { titulo: "Diecisiete años sin vender nada", minutos: 0.9 },
      { titulo: "Sus disfraces", minutos: 1 },
      { titulo: "Hacerse profesional", minutos: 0.9 },
      { titulo: "La parte discutible", minutos: 1.3 },
    ],
  },
  {
    id: "diarios-frida",
  ...
  },
  {
    ...
    porQue: "Las seiscientas cartas desmontan el mito del loco que pintaba por instinto. Era un lector voraz que razonaba cada color.",
    minutos: 4,
    capitulos: [
      { titulo: "El hermano que pagaba", minutos: 0.9 },
      { titulo: "El lector que nadie cuenta", minutos: 0.8 },
      { titulo: "Arlés", minutos: 0.8 },
      { titulo: "Johanna", minutos: 1.5 },
    ],
  },
  {
    id: "sobre-fotografia",
  ...
  },
  {
    ...
    porQue: "Cien páginas con animales que explican cómo una revolución acaba siendo idéntica a lo que derrocó. Se entiende sin saber nada de historia rusa.",
    minutos: 4,
    capitulos: [
      { titulo: "El libro que nadie quería publicar", minutos: 0.6 },
      { titulo: "Los siete mandamientos", minutos: 0.9 },
      { titulo: "Napoleón, Bola de Nieve y Boxer", minutos: 1.3 },
      { titulo: "La pared repintada", minutos: 1.2 },
    ],
  },
  {
    id: "mundo-feliz",
    ...
    porQue: "Orwell temía a quien prohibiera los libros. Huxley temía que no hiciera falta prohibirlos porque nadie quisiera leerlos. Diecisiete años antes de 1984.",
    minutos: 4,
    capitulos: [
      { titulo: "La fábrica de personas", minutos: 0.9 },
      { titulo: "El soma", minutos: 0.7 },
      { titulo: "El salvaje", minutos: 0.9 },
      { titulo: "Quién acertó más", minutos: 1.5 },
    ],
  },
  {
    id: "fahrenheit",
  ...
  },
  {
    ...
    porQue: "Es el libro no religioso más traducido de la historia y se lee en una tarde. Pero casi nadie lo lee de mayor, que es cuando por fin se entiende de qué iba.",
    minutos: 4,
    capitulos: [
      { titulo: "El accidente que era real", minutos: 0.9 },
      { titulo: "El sombrero que era una serpiente", minutos: 0.9 },
      { titulo: "La rosa y el zorro", minutos: 1.1 },
      { titulo: "Lo que casi nadie recuerda", minutos: 1.1 },
    ],
  },
  {
    id: "cien-anos",
    ...
    porQue: "Es la novela que definió el realismo mágico y la más leída en español después del Quijote. Y su primera frase es la más famosa del idioma.",
    minutos: 4,
    capitulos: [
      { titulo: "El manuscrito a plazos", minutos: 0.9 },
      { titulo: "Macondo", minutos: 1 },
      { titulo: "La historia de verdad", minutos: 0.9 },
      { titulo: "Cómo leerlo", minutos: 1.2 },
    ],
  },
  {
    id: "odisea",
  ...
  },
  {
    ...
    porQue: "Un hombre construye una fortuna entera solo para impresionar a una mujer que vive al otro lado de la bahía. Y casi funciona.",
    minutos: 4,
    capitulos: [
      { titulo: "La luz verde", minutos: 0.9 },
      { titulo: "De dónde sale el dinero", minutos: 0.9 },
      { titulo: "El reencuentro", minutos: 0.9 },
      { titulo: "Lo que quedó", minutos: 1.3 },
    ],
  },
  {
    id: "matar-ruisenor",
  ...
  },
  {
    ...
    porQue: "Inventó la ciencia ficción. Y casi todo lo que la gente cree saber de esta historia por las películas está mal.",
    minutos: 4,
    capitulos: [
      { titulo: "El verano sin sol", minutos: 0.9 },
      { titulo: "Lo que las películas cambiaron", minutos: 0.8 },
      { titulo: "Quién es el monstruo", minutos: 0.9 },
      { titulo: "Por qué sigue importando", minutos: 1.5 },
    ],
  },
  {
    id: "dorian-gray",
  ...
  },
  {
    ...
    porQue: "Es el libro más traducido de un autor vivo. Se lee en dos horas y explica mejor que ningún ensayo por qué la gente abandona lo que quiere.",
    minutos: 4,
    capitulos: [
      { titulo: "El fracaso más rentable de la historia", minutos: 0.6 },
      { titulo: "El sueño repetido", minutos: 0.9 },
      { titulo: "El desierto", minutos: 1.2 },
      { titulo: "Por qué engancha y por qué irrita", minutos: 1.3 },
    ],
  },
  {
    id: "mujercitas",
  ...
  },
  {
    ...
    porQue: "Es el resumen de cincuenta años demostrando que no decidimos como creemos. Después de leerlo no vuelves a fiarte igual de tu propio criterio.",
    minutos: 4.1,
    capitulos: [
      { titulo: "Dos sistemas", minutos: 0.9 },
      { titulo: "Los atajos que fallan", minutos: 0.9 },
      { titulo: "Los dos yoes", minutos: 0.9 },
      { titulo: "Lo que él mismo corrigió", minutos: 1.4 },
    ],
  },
  {
    id: "habitos-atomicos",
  ...
  },
  {
    ...
    porQue: "Una sola idea, demostrada con treinta años de experimentos, que cambia cómo hablas a tus hijos, a tu equipo y a ti mismo.",
    minutos: 4.2,
    capitulos: [
      { titulo: "El experimento del elogio", minutos: 0.9 },
      { titulo: "Fija contra de crecimiento", minutos: 0.6 },
      { titulo: "Campeones, jefes y parejas", minutos: 1.6 },
      { titulo: "Lo que se malinterpreta", minutos: 1.1 },
    ],
  },
  {
    ...
    porQue: "Puso en el mapa una idea que hoy damos por evidente y que en 1995 sonaba a herejía: que gestionar emociones es una habilidad que se entrena.",
    minutos: 4.1,
    capitulos: [
      { titulo: "El secuestro de la amígdala", minutos: 0.7 },
      { titulo: "Las cinco piezas", minutos: 1 },
      { titulo: "Los otros y el trabajo", minutos: 1.5 },
      { titulo: "Qué ha quedado", minutos: 1 },
    ],
  },
  {
    id: "flow",
    ...
    porQue: "Explica esos ratos en los que desaparece el tiempo, y demuestra que se pueden provocar a voluntad.",
    minutos: 4,
    capitulos: [
      { titulo: "El buscapersonas", minutos: 0.9 },
      { titulo: "Qué es fluir", minutos: 0.9 },
      { titulo: "El orden de la conciencia", minutos: 0.8 },
      { titulo: "Lo que se le discute", minutos: 1.5 },
    ],
  },
  {
    id: "siete-habitos",
  ...
  },
  {
    ...
    porQue: "Es el manual de trato humano más vendido de la historia. Suena a obviedad hasta que cuentas cuántas de sus reglas rompiste ayer.",
    minutos: 4.1,
    capitulos: [
      { titulo: "El criminal que no se creía criminal", minutos: 0.7 },
      { titulo: "Lo que la gente quiere", minutos: 0.9 },
      { titulo: "El vendedor que dio clases", minutos: 1.3 },
      { titulo: "Ganar discusiones", minutos: 1.2 },
    ],
  },
  {
    id: "deep-work",
  ...
  },
  {
    ...
    porQue: "Unas memorias que se leen como una novela y que plantean la pregunta más difícil: qué haces cuando educarte te separa de tu familia.",
    minutos: 4,
    capitulos: [
      { titulo: "Sin partida de nacimiento", minutos: 0.8 },
      { titulo: "El examen", minutos: 0.9 },
      { titulo: "El precio", minutos: 0.8 },
      { titulo: "Qué es educarse", minutos: 1.5 },
    ],
  },
  {
    id: "poder-habitos",
  ...
  },
  {
    ...
    autor: "Morgan Housel",
    ano: 2020,
    gancho: "Un conserje que dejó ocho millones. Un ejecutivo de Merrill Lynch que quebró. La diferencia no fue el conocimiento.",
    porQue: "No enseña a invertir: enseña por qué gente lista toma decisiones estúpidas con el dinero. Son veinte historias cortas y se entiende todo sin saber nada de finanzas.",
    minutos: 4.2,
    capitulos: [
      { titulo: "El conserje y el ejecutivo", minutos: 0.9 },
      { titulo: "Nadie está loco", minutos: 0.7 },
      { titulo: "El milagro que nadie mira", minutos: 0.8 },
      { titulo: "Lo que el dinero compra de verdad", minutos: 0.9 },
      { titulo: "Margen de error", minutos: 0.9 },
    ],
  },
  {
    id: "padre-rico",
  ...
  },
  {
    ...
    porQue: "Cien años después sigue siendo el mejor primer libro de dinero, porque son parábolas de veinte minutos y no hay una sola fórmula.",
    minutos: 4.1,
    capitulos: [
      { titulo: "El escriba que preguntó", minutos: 0.9 },
      { titulo: "Las siete curas", minutos: 0.9 },
      { titulo: "Las cinco leyes del oro", minutos: 1.4 },
      { titulo: "Por qué aguanta", minutos: 1 },
    ],
  },
  {
    id: "freakonomics",
    ...
    porQue: "Inventó un género entero: usar las herramientas de la economía para responder preguntas que no son de economía.",
    minutos: 4,
    capitulos: [
      { titulo: "La economía aplicada a cosas raras", minutos: 1 },
      { titulo: "Los maestros y los luchadores", minutos: 0.8 },
      { titulo: "El capítulo polémico", minutos: 0.8 },
      { titulo: "Los nombres y los padres", minutos: 1.3 },
    ],
  },
  {
    id: "cisne-negro",
    ...
    porQue: "Explica por qué los acontecimientos que cambian el mundo son siempre los que nadie predijo, y por qué después parecen obvios.",
    minutos: 4,
    capitulos: [
      { titulo: "El pavo de Acción de Gracias", minutos: 0.8 },
      { titulo: "Dos países", minutos: 0.9 },
      { titulo: "Por qué no lo vemos", minutos: 0.8 },
      { titulo: "Qué hacer con eso", minutos: 1.5 },
    ],
  },
  {
    id: "antifragil",
  ...
  },
  {
    ...
    porQue: "Cuarenta entrevistas con él y cien con quienes le rodearon. Es la biografía autorizada que no le deja bien, y por eso vale.",
    minutos: 4,
    capitulos: [
      { titulo: "El encargo", minutos: 0.8 },
      { titulo: "El campo de distorsión de la realidad", minutos: 0.9 },
      { titulo: "El despido y el regreso", minutos: 0.8 },
      { titulo: "El final", minutos: 1.5 },
    ],
  },
  {
    id: "factfulness",
  ...
  },
  {
    ...
    porQue: "Cambió la conversación pública sobre el sueño. Conviene leerlo sabiendo que algunas de sus cifras han sido cuestionadas con razón.",
    minutos: 4,
    capitulos: [
      { titulo: "La única cosa que no puedes saltarte", minutos: 0.6 },
      { titulo: "Dos sueños distintos", minutos: 0.8 },
      { titulo: "Búhos, adolescentes y el turno de noche", minutos: 1.5 },
      { titulo: "Qué hacer y qué matizar", minutos: 1.1 },
    ],
  },
  {
    id: "cuerpo-cuenta",
  ...
  },
  {
    ...
    porQue: "Casi todos respiramos mal y nadie nos ha enseñado a hacerlo bien. Es el libro de salud con mejor relación entre esfuerzo y resultado.",
    minutos: 4,
    capitulos: [
      { titulo: "El experimento de Stanford", minutos: 0.7 },
      { titulo: "Menos y más lento", minutos: 0.9 },
      { titulo: "Los pulmoneros", minutos: 1.5 },
      { titulo: "Bocas que encogen", minutos: 1 },
    ],
  },
  {
    ...
    porQue: "Convierte el órgano del que nadie quiere hablar en el más interesante del cuerpo, con humor y sin una sola palabra técnica sin explicar.",
    minutos: 4,
    capitulos: [
      { titulo: "Una charla que salió bien", minutos: 0.7 },
      { titulo: "Cómo funciona de verdad", minutos: 1.1 },
      { titulo: "El segundo cerebro", minutos: 1 },
      { titulo: "Qué hacer y qué no creerse", minutos: 1.2 },
    ],
  },
  {
    id: "outlive",
  ...
  },
  {
    ...
    porQue: "Provocó una revolución mundial en la forma de correr y de fabricar zapatillas a partir de una sola pregunta: ¿por qué me duele?",
    minutos: 4,
    capitulos: [
      { titulo: "La pregunta del pie", minutos: 0.9 },
      { titulo: "La zapatilla", minutos: 0.9 },
      { titulo: "Lo que provocó", minutos: 0.8 },
      { titulo: "Lo que queda", minutos: 1.4 },
    ],
  },
  {
    id: "dilema-omnivoro",
    ...
    porQue: "Es el libro que cambió la conversación pública sobre comida, y su consejo final cabe en siete palabras.",
    minutos: 4,
    capitulos: [
      { titulo: "La pregunta del omnívoro", minutos: 0.7 },
      { titulo: "Todo es maíz", minutos: 0.9 },
      { titulo: "Lo ecológico industrial", minutos: 1 },
      { titulo: "Siete palabras", minutos: 1.5 },
    ],
  },
  {
    id: "aliento-aire",

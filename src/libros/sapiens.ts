  ...
  partes: [
    {
      ...
      tarjetas: [
        ...
        {
          forma: "clave",
          rotulo: "El salto que dio",
          frase: "De las crónicas de unos cuantos caballeros a setenta mil años de humanidad entera.",
        },
        {
          forma: "texto",
          texto:
        ...
        {
          forma: "clave",
          rotulo: "El dato del arranque",
          frase: "Hace cien mil años había al menos seis especies humanas distintas caminando por el planeta.",
        },
        {
          forma: "texto",
          texto:
    ...
    {
      titulo: "Primera parada: creer en cosas que no existen",
      tarjetas: [
        {
          forma: "texto",
          texto:
        ...
        {
          forma: "clave",
          rotulo: "Su tesis en una frase",
          frase: "Dominamos el planeta porque somos capaces de creernos lo mismo entre muchísimos desconocidos.",
        },
        {
          forma: "texto",
          texto:
        ...
        },
        {
          forma: "clave",
          rotulo: "Qué cambió",
          frase: "Se descubrió que hubo mezcla, y que un europeo o un asiático lleva hoy entre un uno y un cuatro por ciento de ADN neandertal.",
        },
        {
          forma: "texto",
          texto:
    ...
    {
      titulo: "Segunda parada: el mayor fraude de la historia",
      tarjetas: [
        {
          forma: "texto",
          texto:
        ...
        {
          forma: "clave",
          rotulo: "La frase que resume el capítulo",
          frase: "No fuimos nosotros quienes domesticamos el trigo. Fue el trigo el que nos domesticó a nosotros.",
        },
        {
          forma: "texto",
          texto:
        ...
        {
          forma: "clave",
          rotulo: "Su definición",
          frase: "El dinero es la única historia que se han creído todos los pueblos del mundo a la vez.",
        },
        {
          forma: "texto",
          texto:
    ...
    {
      titulo: "Tercera parada: donde falla y qué no dice",
      tarjetas: [
        {
          forma: "texto",
          texto:
        ...
        {
          forma: "clave",
          rotulo: "Lo que sí es suyo",
          frase: "Haber juntado todo eso en un relato que se lee del tirón y se recuerda entero.",
        },
        {
          forma: "texto",
          texto:
        ...
        {
          forma: "clave",
          rotulo: "Su virtud principal",
          frase: "Convierte setenta mil años en una sola historia con hilo, y eso casi nadie sabe hacerlo.",
        },
        {
          forma: "texto",
          texto:
            "Conviene leerlo como un ensayo con ideas, no como un manual.",
        },
      ],
    },
    {
      titulo: "Destino: la pregunta por la felicidad",
      tarjetas: [
        {
          forma: "texto",
          texto:
        ...
        },
        {
          forma: "clave",
          rotulo: "El obstáculo",
          frase: "El bienestar depende sobre todo de la bioquímica, y la bioquímica vuelve siempre a su punto de partida.",
        },
        {
          forma: "texto",
          texto:
        ...
        },
        {
          forma: "texto",
          texto:
            "Las herramientas que enumera son tres y ya existen. La ingeniería biológica, que modifica organismos vivos; la fusión de cuerpo y máquina, con prótesis y sensores; y la creación de vida inorgánica, que es la que menos se entiende y la que más consecuencias tendría.",
        },
        {
          forma: "texto",
          texto:
        ...
        },
        {
          forma: "texto",
          texto:
            "Homo Deus, que anda por este catálogo, es la continuación directa.",
        },
        {
          forma: "clave",
          rotulo: "La pregunta con la que cierra",
          frase: "¿Hay algo más peligroso que unos dioses insatisfechos que no saben lo que quieren?",
        },
        {
          forma: "texto",
          texto:
            "Y ahí se acaba el recorrido que empezó con seis especies humanas.",
        },
      ],
    },
  ],

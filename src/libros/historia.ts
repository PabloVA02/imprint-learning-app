...
export const INFINITO_JUNCO: Resumen = {
  ...
  autor: "Irene Vallejo",
  ano: 2019,
  gancho: "Un ensayo sobre la historia del libro escrito por una filóloga desconocida. Lleva más de un millón de ejemplares vendidos.",
  porQue:
    "Cuenta tres mil años de historia de los libros como si fuera una novela de aventuras, y hace que te den ganas de leer más.",
  partes: [
    {
      titulo: "Los cazadores de libros",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "Irene Vallejo abre con una imagen que no parece de un ensayo. Unos jinetes recorren los caminos del Mediterráneo con una misión extraña y peligrosa: encontrar libros. Los pagan a precio de oro, los roban si hace falta. Trabajan para los reyes de Egipto, que quieren tenerlos todos.",
        },
        {
          forma: "arte",
          texto:
            "El método de Alejandría era descarado. Todo barco que atracaba en el puerto era registrado, y si llevaba un libro lo requisaban. Lo copiaban, devolvían la copia al dueño y se quedaban con el original. En los registros aparecían anotados como «libros de los barcos».",
          arte: "mapa",
        },
        {
          forma: "clave",
          rotulo: "La ambición",
          frase: "Querían reunir todos los libros del mundo. Es la única vez en la historia que eso fue casi posible.",
        },
        {
          forma: "texto",
          texto:
            "Vallejo escribe esto en primera persona, mezclando la historia antigua con su propia vida: su padre leyéndole de niña, sus años de estudiante de clásicas, un hijo enfermo en un hospital. Ese cruce es lo que hace el libro distinto, y también lo que a algunos les sobra.",
        },
      ],
    },

    {
      titulo: "De qué está hecho un libro",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "El título viene de aquí. El papiro se hacía con la médula de una planta que crecía en el delta del Nilo, un junco. Se cortaba en tiras finas, se cruzaban en dos capas, se prensaban y se secaban. En esa lámina frágil cabe, dice Vallejo, el infinito: todo lo que alguien sea capaz de imaginar.",
        },
        {
          forma: "texto",
          texto:
            "Cuenta también la guerra comercial que lo sustituyó. Egipto cortó el suministro de papiro a la biblioteca rival de Pérgamo para hundirla, y allí perfeccionaron una alternativa con pieles de animal — el pergamino, que lleva el nombre de la ciudad. Era mucho más caro y muchísimo más duradero, y por eso lo que ha llegado hasta nosotros llegó en piel, no en planta.",
        },
        {
          forma: "clave",
          rotulo: "El cambio de forma",
          frase: "El rollo se lee con las dos manos y sin poder saltar. El códice —hojas cosidas— permite abrir por una página. Es el mismo salto que del casete al mp3.",
        },
        {
          forma: "arte",
          texto:
            "Y explica por qué ganó el códice, que es un detalle histórico precioso: lo adoptaron los cristianos, una secta minoritaria y pobre, porque era barato, aprovechaba las dos caras y se escondía fácil bajo la ropa. La forma del libro que usamos hoy la fijó gente que necesitaba que no se la vieran.",
          arte: "estanteria",
        },
      ],
    },
    ...
    {
      titulo: "Quién podía leer",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "La segunda mitad del libro se ocupa de Roma y de una pregunta incómoda: quién tenía acceso a todo esto. La respuesta es casi nadie. Los libros los copiaban esclavos, a mano, en talleres donde un lector dictaba y decenas escribían a la vez. Un error del que dictaba se multiplicaba por cincuenta.",
        },
        {
          forma: "texto",
          texto:
            "Vallejo dedica páginas a las mujeres que consiguieron leer y escribir a pesar de todo, y a lo poco que ha sobrevivido de ellas. De Safo, la poeta más admirada de la Antigüedad, queda un poema completo y fragmentos sueltos. No se perdió por accidente: durante siglos nadie consideró que valiera la pena seguir copiándolo.",
        },
        {
          forma: "clave",
          rotulo: "La idea central",
          frase: "Un libro sobrevive solo si alguien decide copiarlo otra vez. Todo lo que tenemos ha pasado esa criba, generación tras generación.",
        },
        {
          forma: "texto",
          texto:
            "De ahí saca lo que da sentido al ensayo entero: los clásicos no son los mejores libros de la Antigüedad. Son los que alguien siguió eligiendo. Hubo un monje, un copista o un bibliotecario que decidió gastar meses de su vida en ese texto y no en otro, y esa cadena de decisiones anónimas es la razón de que hoy exista lo que existe.",
        },
      ],
    },

    {
      titulo: "Por qué vendió tanto",
      tarjetas: [
        {
          forma: "arte",
          texto:
            "El éxito del libro es en sí mismo una historia rara. Un ensayo de más de cuatrocientas páginas sobre historia de la lectura, escrito por una filóloga que no era conocida, publicado por una editorial pequeña. Corrió de boca en boca hasta superar el millón de ejemplares y traducirse a más de treinta idiomas.",
          arte: "aprendizaje",
        },
        {
          forma: "texto",
          texto:
            "Funciona porque no explica: cuenta. Cada capítulo es corto, arranca con una escena y salta entre la Antigüedad y el presente sin pedir permiso — de Alejandría a una biblioteca de barrio, de Aristóteles a una serie de televisión. Nunca da por hecho que el lector sepa nada, y nunca le trata como si no supiera.",
        },
        {
          forma: "texto",
          texto:
            "Su pega es la otra cara de esa virtud. La estructura es libre hasta ser dispersa, las digresiones personales pueden hacerse largas, y quien busque historia rigurosa y ordenada tiene mejores manuales. Este no es un libro de consulta: es un libro para que te entren ganas de leer otros.",
        },
        {
          forma: "clave",
          rotulo: "Para llevarte",
          frase: "Lo que llamamos cultura es una cadena de gente que decidió copiar a mano algo que le pareció que no debía perderse.",
        },
        {
          forma: "texto",
          texto:
            "Vallejo dedica también unas páginas preciosas a la lectura en voz alta. Durante siglos leer fue una actividad sonora: los textos antiguos se escribían sin separación entre palabras ni signos de puntuación, y descifrarlos exigía pronunciarlos. Cuenta la escena en que san Agustín observa a su maestro Ambrosio leyendo en silencio, moviendo solo los ojos, y lo describe como algo tan extraño que se para a explicarlo. Leer callado —que hoy nos parece lo normal— fue en su momento una novedad desconcertante.",
        },
      ],
    },
  ],

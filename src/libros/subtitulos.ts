...
export const SIN_SUBTITULO: string[] = ["quijote", "matar-ruisenor", "orgullo-prejuicio", "alquimista", "sombra-viento", "steve-jobs", "gen-egoista", "odisea", "republica-platon", "mundo-feliz", "fahrenheit", "crimen-castigo", "metamorfosis", "gran-gatsby", "senor-moscas", "frankenstein", "dorian-gray", "dracula", "moby-dick", "montecristo", "viejo-mar", "nombre-rosa", "pedro-paramo", "guardian-centeno", "si-esto-hombre", "los-miserables", "casi-todo", "extranjero", "ana-karenina", "madame-bovary", "historia-arte", "ficciones", "rayuela", "casa-espiritus", "hombre-rico-babilonia", "aliento-aire", "modos-ver", "cartas-joven-poeta", "guerra-y-paz", "origenes-totalitarismo", "capital-siglo-xxi", "homenaje-cataluna", "pilares-tierra"];

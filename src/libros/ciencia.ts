...
export const MUNDO_DEMONIOS: Resumen = {
  ...
  autor: "Carl Sagan",
  ano: 1995,
  gancho: "Su última obra. La escribió mientras se moría, y va sobre cómo distinguir lo verdadero de lo que suena bien.",
  porQue:
    "Contiene el mejor manual que existe para no dejarse engañar, escrito treinta años antes de que hiciera tanta falta.",
  partes: [
    {
      titulo: "El taxista",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "Sagan abre con una escena real. Un taxista le reconoce y se pone eufórico: lleva toda la vida queriendo preguntarle a un científico. Y empieza a soltar preguntas — sobre extraterrestres que abducen gente, sobre cristales que curan, sobre canalizadores que hablan con espíritus antiguos, sobre la profecía de Nostradamus.",
        },
        {
          forma: "arte",
          texto:
            "Sagan va desmontándolo todo, con datos, uno por uno. Y el hombre se va apagando durante el viaje. Al bajar, Sagan se queda con una tristeza que arranca el libro: aquel tipo tenía una curiosidad enorme y nadie le había dado nunca nada de verdad con lo que alimentarla. Solo le habían vendido tonterías.",
          arte: "noche",
        },
        {
          forma: "clave",
          rotulo: "La tesis",
          frase: "El problema no es que la gente crea cosas raras. Es que la ciencia real es más asombrosa y nadie se la ha contado.",
        },
        {
          forma: "texto",
          texto:
            "El libro salió en 1995 y Sagan murió al año siguiente de una enfermedad de la médula ósea, a los sesenta y dos. Sabía que estaba enfermo mientras lo escribía, y se nota en la urgencia del tono: es menos un ensayo que un aviso.",
        },
      ],
    },

    {
      titulo: "El dragón del garaje",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "El capítulo más famoso plantea un juego. Te digo que en mi garaje vive un dragón. Vas a mirar y no ves nada: es que es invisible. Propones esparcir harina para ver sus huellas; te explico que flota. Sugieres pintura en aerosol para revelar su silueta; resulta que es incorpóreo. Propones un sensor de calor; su fuego no da calor.",
        },
        {
          forma: "clave",
          rotulo: "La pregunta",
          frase: "¿Qué diferencia hay entre un dragón invisible, flotante e indetectable y ningún dragón en absoluto?",
        },
        {
          forma: "texto",
          texto:
            "Ninguna, y ese es el punto. Cuando una afirmación se blinda contra toda comprobación posible, deja de decir nada sobre el mundo. Sagan añade el matiz importante: eso no demuestra que el dragón no exista. Demuestra que no hay motivo para creerlo, que es distinto y suficiente.",
        },
        {
          forma: "arte",
          texto:
            "Su regla es la que se sigue repitiendo hoy en cualquier discusión seria: afirmaciones extraordinarias exigen pruebas extraordinarias. Y su equilibrio, el más difícil de mantener — hay que estar abierto a cualquier idea nueva y ser implacable al examinarla. Solo lo primero es credulidad; solo lo segundo, cerrazón.",
          arte: "explorar",
        },
      ],
    },
    ...
    {
      titulo: "El detector de camelos",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "El centro del libro es una caja de herramientas concreta. Sagan enumera cómo comprobar cualquier afirmación: buscar confirmación independiente de los hechos, fomentar el debate entre quienes saben, desconfiar de los argumentos de autoridad, construir más de una hipótesis y tratar de tumbar la tuya propia.",
        },
        {
          forma: "texto",
          texto:
            "Y añade su regla favorita, la más útil en la práctica: si algo se puede medir, mídelo, aunque sea de forma tosca. Una cifra aproximada permite descartar disparates que una discusión con palabras puede sostener indefinidamente.",
        },
        {
          forma: "clave",
          rotulo: "El principio de Occam",
          frase: "Ante dos explicaciones que encajan igual con los datos, elige la que necesite menos suposiciones.",
        },
        {
          forma: "texto",
          texto:
            "Y una prueba más que Sagan considera decisiva: preguntarse si la afirmación se puede comprobar de alguna manera. No basta con que suene coherente. Si no existe ningún experimento, ninguna observación y ningún dato que pudiera demostrar que es falsa, entonces no es una explicación del mundo — es una historia sobre él.",
        },
        {
          forma: "texto",
          texto:
            "La segunda parte es un catálogo de trampas del lenguaje que conviene tener identificadas: atacar a quien habla en vez de a lo que dice, plantear solo dos opciones cuando hay más, usar una autoridad que no lo es del tema, apelar al miedo, deducir causa de una simple coincidencia temporal, o retorcer lo que dijo el otro para rebatir una versión más fácil.",
        },
      ],
    },
      ...
      tarjetas: [
        {
          forma: "arte",
          texto:
            "El final del libro es lo que ha hecho que se siga citando. Sagan describe el país que teme dejar: una sociedad que depende por completo de la ciencia y la tecnología, y donde casi nadie entiende nada de ciencia ni de tecnología. Una población incapaz de distinguir lo verdadero de lo que le suena bien, deslizándose sin darse cuenta hacia la superstición.",
          arte: "memoria",
        },
        {
          forma: "clave",
          rotulo: "Lo que más temía",
          frase: "No la ignorancia, sino perder la capacidad de saber qué preguntas hacerle a quien afirma algo.",
        },
        {
          forma: "texto",
          texto:
            "Sagan defiende además una idea que suena rara viniendo de un científico: que el escepticismo hay que enseñarlo con cariño, no con desprecio. Recuerda al taxista del principio y dice que reírse de quien cree en algo raro es la forma más eficaz de asegurarte de que no te escuche nunca. Su propuesta es enseñar a los niños a preguntar cómo se sabe eso — no como arma para ganar discusiones, sino como costumbre. Un chaval que pregunta «¿y cómo lo comprobaron?» está protegido de por vida, y no hace falta que sepa física.",
        },
        {
          forma: "texto",
          texto:
            "Escribió también que su mayor preocupación era la desaparición del periodismo que investiga y la reducción de todo a titulares de treinta segundos. Leído en 2026, es de esos textos que producen una sensación incómoda por lo bien que describen algo que aún no existía.",
        },
        {
          forma: "texto",
          texto:
            "Su parte más débil son los capítulos dedicados a demoler abducciones y ovnis: se extienden mucho y el fenómeno concreto interesa hoy bastante menos. Pero el método sirve igual para un bulo de WhatsApp, un curandero o un anuncio, que es exactamente para lo que Sagan lo escribió.",
        },
      ],
    },
  ],

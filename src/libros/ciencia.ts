...
export const GEN_EGOISTA: Resumen = {
  ...
  ano: 1976,
  gancho: "Le dio la vuelta a la evolución: no somos nosotros los que usamos los genes, son ellos los que nos usan a nosotros.",
  porQue:
    "Cambió el punto de vista de toda la biología con un solo giro de perspectiva, y de paso inventó la palabra «meme».",
  partes: [
    {
      titulo: "El cambio de punto de vista",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "Hasta 1976 la evolución se explicaba casi siempre igual: los animales luchan por sobrevivir y los mejores dejan más descendencia. Dawkins propuso mirar exactamente lo mismo desde otro sitio, y al cambiar de sitio cambió todo el paisaje. La unidad que compite no es el individuo ni la especie: es el gen.",
        },
        {
          forma: "clave",
          rotulo: "La imagen que lo resume",
          frase: "No somos individuos con genes. Somos máquinas de supervivencia construidas por los genes para transportarlos.",
        },
        {
          forma: "arte",
          texto:
            "La lógica es sencilla. Un cuerpo dura décadas y desaparece. Un gen puede llevar millones de años copiándose. Desde esa escala, el cuerpo es un vehículo temporal: se construye, cumple su función de reproducir la información y se descarta. Los que hoy existimos descendemos únicamente de genes que fueron buenos copiándose.",
          arte: "aprendizaje",
        },
        {
          forma: "texto",
          texto:
            "Dawkins avisa de una confusión que persiguió al libro toda su vida: «egoísta» no significa cruel ni describe una intención. Un gen no quiere nada. Es una metáfora contable — se comporta <em>como si</em> su único objetivo fuera perpetuarse, porque los que no se comportaban así no llegaron hasta aquí.",
        },
      ],
    },

    {
      titulo: "Por qué existe la generosidad",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "Lo interesante es que esa perspectiva explica justo lo contrario de lo que parece. Si todo es competencia, ¿por qué una ardilla grita al ver un halcón, delatándose y arriesgando su vida para avisar a las demás?",
        },
        {
          forma: "texto",
          texto:
            "Porque las que la oyen son sus hermanas y sus primas, y comparten buena parte de sus genes. Desde el punto de vista del gen da igual en qué cuerpo esté: salvar a varios parientes puede propagarlo mejor que salvar el propio. De ahí sale la broma célebre de un biólogo anterior, que decía que daría su vida por dos hermanos o por ocho primos.",
        },
        {
          forma: "clave",
          rotulo: "La consecuencia",
          frase: "El altruismo familiar no contradice el egoísmo genético. Es su forma más eficiente.",
        },
        {
          forma: "arte",
          texto:
            "Y el mismo marco explica el altruismo entre extraños mediante lo que llama el altruismo recíproco: te ayudo hoy porque el sistema premia a los que devuelven favores. Dawkins dedica páginas a los torneos donde se enfrentaron estrategias por ordenador, y la ganadora fue la más simple de todas — empezar cooperando, y después hacer lo que el otro hiciera la vez anterior.",
          arte: "explorar",
        },
      ],
    },
      ...
      tarjetas: [
        {
          forma: "texto",
          texto:
            "En el último capítulo Dawkins se pregunta si existe algún otro replicador además del gen, y propone uno: las ideas. Melodías, modas, creencias, frases hechas, formas de construir un arco. Cosas que saltan de un cerebro a otro copiándose, mutando y compitiendo por espacio.",
        },
        {
          forma: "clave",
          rotulo: "La palabra que inventó",
          frase: "«Meme», acortando el griego <em>mimeme</em> para que sonara parecido a «gen». Casi cincuenta años antes de internet.",
        },
        {
          forma: "texto",
          texto:
            "Su ejemplo favorito era la melodía que se te pega y no puedes quitarte. No la eliges, no te beneficia y ocupa espacio en tu cabeza durante días. Vista así, se comporta exactamente como un parásito que ha encontrado un buen huésped — y las ideas que más circulan suelen tener esa misma cualidad pegajosa.",
        },
        {
          forma: "texto",
          texto:
            "Su punto es que una idea no se propaga por ser verdadera ni por ser buena para ti, igual que un gen no se propaga por hacerte feliz. Se propaga por ser buena copiándose. Una canción pegadiza gana a una mejor pero difícil; un bulo indignante corre más que un desmentido aburrido.",
        },
        {
          forma: "texto",
          texto:
            "Es la parte más discutida del libro y la más profética. La memética nunca cuajó como ciencia seria, pero cualquiera que haya visto cómo circula algo en redes reconoce el mecanismo al instante.",
        },
      ],
    },

    {
      titulo: "Lo que se le critica",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "El título le ha costado cinco décadas de malentendidos. Muchísima gente lo ha leído como si dijera que las personas somos egoístas por naturaleza y que la biología justifica el «sálvese quien pueda». Dawkins ha repetido mil veces que el libro dice lo contrario, y que llegó a arrepentirse de no haberlo titulado <em>El gen inmortal</em>.",
        },
        {
          forma: "arte",
          texto:
            "Hay también críticas científicas de fondo. Biólogos importantes han defendido que la selección actúa a varios niveles a la vez y no solo sobre el gen, y que el desarrollo de un organismo es mucho menos «programado» de lo que sugiere la metáfora de la máquina. El debate sigue abierto.",
          arte: "memoria",
        },
        {
          forma: "clave",
          rotulo: "Su última frase, la que importa",
          frase: "Somos los únicos animales capaces de rebelarnos contra los designios de sus propios genes.",
        },
        {
          forma: "texto",
          texto:
            "Esa última frase no es un adorno y merece explicarse. Ningún otro animal usa anticonceptivos, adopta hijos ajenos ni dedica su vida a desconocidos. Si los genes nos hubieran programado sin margen, nada de eso sería posible. Dawkins sostiene que la conciencia y la cultura nos dieron una herramienta que ningún gen previó: la capacidad de simular el futuro y decidir en contra de lo que el impulso pide. Somos, dice, la única especie construida por replicadores egoístas que puede plantarse y decirles que no.",
        },
        {
          forma: "texto",
          texto:
            "Con eso puesto, sigue siendo uno de los libros de divulgación mejor escritos que existen. No exige saber biología, se lee como un ensayo de ideas y tiene la rara virtud de que después de leerlo miras a un animal —y a ti mismo— de otra manera.",
        },
      ],
    },
  ],

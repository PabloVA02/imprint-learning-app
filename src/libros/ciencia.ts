...
export const CASI_TODO: Resumen = {
  ...
  porQue:
    "Cuenta toda la ciencia desde el Big Bang hasta el ser humano contando las peleas, los celos y las chapuzas de los científicos.",
  partes: [
    {
      titulo: "La pregunta del avión",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "Bill Bryson viajaba en un vuelo sobre el Pacífico cuando se le ocurrió mirar el océano por la ventanilla y darse cuenta de que no tenía ni idea de cómo había llegado a existir aquello. Ni el mar, ni el planeta, ni él mismo. Había sido un buen alumno y era un escritor de éxito, y no sabía responder a nada de eso.",
        },
        {
          forma: "arte",
          texto:
            "Recordó sus libros de texto del colegio: gruesos, grises, escritos como si el objetivo fuera que no se te quedara nada. Decidió pasar tres años leyendo y entrevistando a científicos para escribir el libro de ciencia que le habría gustado leer de joven. No tiene una sola fórmula.",
          arte: "estanteria",
        },
        {
          forma: "clave",
          rotulo: "El truco del libro",
          frase: "No cuenta qué sabemos. Cuenta cómo lo averiguamos, y quién se peleó con quién por conseguirlo.",
        },
        {
          forma: "texto",
          texto:
            "Ese giro es todo. La ciencia deja de ser una lista de datos y se convierte en una historia con personajes: obsesivos, envidiosos, brillantes y a menudo bastante raros. Vendió millones de ejemplares y ganó los principales premios de divulgación británicos.",
        },
      ],
    },

    {
      titulo: "Los científicos que nadie cuenta",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "El libro está lleno de personajes olvidados. Henry Cavendish, tan patológicamente tímido que se comunicaba con su ama de llaves por notas y encargaba la cena por escrito; pesó la Tierra entera desde una cabaña de su jardín, con una precisión que aguantó un siglo.",
        },
        {
          forma: "texto",
          texto:
            "O Thomas Midgley, probablemente el hombre que más daño ha hecho a la atmósfera sin proponérselo: inventó la gasolina con plomo y después los CFC de los aerosoles. Para demostrar que el plomo era inofensivo, se lavó las manos en él y lo inhaló delante de la prensa. Estuvo un año de baja por envenenamiento.",
        },
        {
          forma: "clave",
          rotulo: "El patrón",
          frase: "Casi ningún gran hallazgo fue limpio. Hubo suerte, obsesión, error y mucha gente robándole el mérito a otra.",
        },
        {
          forma: "texto",
          texto:
            "Bryson repite una observación que resulta consoladora: una parte enorme de la ciencia la hicieron aficionados. Párrocos que catalogaban fósiles los domingos, funcionarios que medían mareas, médicos rurales que anotaban el tiempo durante cuarenta años. La figura del investigador profesional con financiación es reciente; antes bastaba con ser terco y llevar buenos cuadernos.",
        },
        {
          forma: "arte",
          texto:
            "Bryson insiste en los que quedaron fuera del reparto. El geólogo que dedujo la edad real de la Tierra y murió arruinado. La química cuyos datos fueron decisivos y cuyo nombre no apareció. Los paleontólogos americanos que se odiaban tanto que dinamitaban los yacimientos del rival antes de irse.",
          arte: "museo",
        },
      ],
    },
    ...
    {
      titulo: "Lo pequeño y lo enorme",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "Cuando explica ciencia lo hace siempre con comparaciones domésticas. Si un átomo fuera del tamaño de una catedral, el núcleo sería una mosca en el centro — y en esa mosca está casi toda la masa. La materia sólida es, en su mayor parte, espacio vacío.",
        },
        {
          forma: "texto",
          texto:
            "Con el tiempo geológico hace lo mismo. Si extiendes los brazos para representar la historia de la Tierra, toda la vida compleja cabe en una mano, y un solo pase de lima de uñas por la punta del dedo borraría la historia humana entera.",
        },
        {
          forma: "clave",
          rotulo: "La conclusión que repite",
          frase: "Que estemos aquí es una acumulación absurda de casualidades que no tenían por qué salir bien.",
        },
        {
          forma: "texto",
          texto:
            "Dedica también un tramo a lo poco que sabemos de nuestro propio planeta: se ha explorado una fracción mínima del fondo oceánico, no hay catálogo completo de las especies que existen, y ni siquiera está claro cuántos tipos de bacterias viven en un gramo de tierra de jardín.",
        },
      ],
    },

    {
      titulo: "Lo bueno y lo flojo",
      tarjetas: [
        {
          forma: "arte",
          texto:
            "Su mayor virtud es que no presupone nada y no te trata como a un tonto. Bryson escribe desde su propia ignorancia — pregunta lo que preguntaría cualquiera, incluidas las cosas que un experto ya no se plantea— y por eso el libro funciona igual para alguien que odiaba la ciencia en el colegio.",
          arte: "aprendizaje",
        },
        {
          forma: "texto",
          texto:
            "Sus límites también son claros. Es de 2003, así que la parte de cosmología, genética y paleoantropología se ha quedado desfasada en varios puntos. Y en su momento se le señalaron errores factuales sueltos, algunos corregidos en ediciones posteriores.",
        },
        {
          forma: "texto",
          texto:
            "Tampoco es un libro para aprender ciencia en sentido estricto: al terminarlo no sabrás hacer nada. Lo que te llevas es otra cosa — la sensación de que todo esto lo averiguaron personas concretas, muchas veces por accidente, y que aún queda muchísimo por saber.",
        },
        {
          forma: "clave",
          rotulo: "Para llevarte",
          frase: "La ciencia no es un libro de respuestas. Es el registro de lo que un montón de gente terca consiguió averiguar.",
        },
        {
          forma: "texto",
          texto:
            "Su capítulo sobre las extinciones es de los que se recuerdan. Bryson recuerda que el noventa y nueve por ciento de las especies que han existido ya no existen, que ser una especie es una condición temporal por definición, y que llevamos varios episodios en los que casi todo lo vivo desapareció en un suspiro geológico. Y añade el detalle inquietante: en cada uno de ellos, lo que se extinguió fue sobre todo lo grande, lo especializado y lo que estaba arriba en la cadena. Que es exactamente nuestra descripción.",
        },
      ],
    },
  ],

...
export const CARTAS_THEO: Resumen = {
  ...
  porQue:
    "Las cartas desmontan el mito del loco que pintaba por instinto: era un lector voraz que razonaba cada color. Y existen porque una viuda de veintiocho años decidió que existieran.",
  partes: [
    {
      titulo: "El evangelista despedido de las minas",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "En el invierno de 1879, en una aldea minera del sur de Bélgica, un predicador holandés de veintiséis años ha regalado su ropa y su dinero a los mineros, duerme sobre paja en una choza y se lava la cara con carbón para parecerse a ellos. La iglesia que lo envió decide despedirlo.",
        },
        {
          forma: "texto",
          texto:
            "El motivo oficial es que su exceso de celo perjudicaba la dignidad del sacerdocio, y que además hablaba muy mal en público. Vincent van Gogh se queda en el Borinage sin trabajo, sin plan y sin hablarse con casi nadie de su familia, y pasa casi un año en silencio.",
        },
        {
          forma: "texto",
          texto:
            "Aquel año fue el peor de su vida y también el más productivo en secreto. Recorrió a pie kilómetros por Bélgica y el norte de Francia, durmió en pajares, y en las cartas posteriores cuenta que dibujaba a los mineros y a sus mujeres cargando sacos de carbón sobre la nieve.",
        },
        {
          forma: "texto",
          texto:
            "De ese silencio sale la carta más importante de su vida, escrita a su hermano Theo en julio de 1880 desde Cuesmes. Es larguísima, empieza pidiendo disculpas por haber tardado tanto en escribir y contiene la imagen que resume todo lo que vendrá después.",
        },
        {
          forma: "texto",
          texto:
            "En esa misma carta le pide a Theo que no lo trate como un vago, y hace una distinción que sostiene el resto de su vida. Hay un holgazán por pereza y hay otro que está ocioso a la fuerza, corroído por las ganas de hacer algo, encerrado por las circunstancias en un sitio imposible.",
        },
        {
          forma: "arte",
          texto:
            "Dice que hay pájaros enjaulados en primavera que saben perfectamente que hay algo para lo que servirían, lo sienten con todo el cuerpo, y no pueden hacerlo. Y que un hombre así no siempre sabe lo que podría hacer, pero sabe con seguridad que sirve para algo y que en esa jaula no lo hará.",
          arte: "escritor",
        },
        {
          forma: "clave",
          rotulo: "La decisión",
          frase: "Empezó a dibujar en serio a los veintisiete años. Diez años después estaba muerto y había hecho unas dos mil obras.",
        },
        {
          forma: "texto",
          texto:
            "El desglose de esa cifra ayuda a medir el ritmo. Se le atribuyen unos ochocientos sesenta óleos y más de mil dibujos y acuarelas, y la mayoría de los óleos son de los dos últimos años de su vida. Empezó tarde, trabajó deprisa y aceleró justo cuando peor estaba de salud.",
        },
        {
          forma: "texto",
          texto:
            "Conviene ver de dónde venía, porque explica su cultura visual. Había trabajado seis años como empleado de la casa de arte Goupil en La Haya, Londres y París, vendiendo grabados y cuadros a clientes ricos, hasta que lo despidieron por discutir con los compradores el gusto de lo que compraban.",
        },
        {
          forma: "texto",
          texto:
            "Eso significa que sabía perfectamente cómo funcionaba el mercado del arte antes de intentar entrar en él. Conocía los precios, los marchantes, qué se vendía y por qué, y aun así eligió pintar campesinos con colores que sabía que nadie iba a colgar en un salón burgués.",
        },
        {
          forma: "texto",
          texto:
            "Entre medias fue maestro auxiliar en dos internados ingleses y dependiente de una librería en Dordrecht, donde se pasaba las horas traduciendo la Biblia a cuatro idiomas en columnas paralelas en vez de atender el mostrador. Ninguno de esos trabajos le duró más de unos meses.",
        },
        {
          forma: "texto",
          texto:
            "Cuando decide ser pintor, lo primero que hace no es coger un pincel: es pedirle a Theo manuales de dibujo, láminas para copiar y un tratado de anatomía. Pasa dos años copiando figuras de un método académico francés antes de permitirse pintar nada propio.",
        },
        {
          forma: "texto",
          texto:
            "También intentó formarse por la vía normal y le salió mal dos veces. Estuvo unos meses en la academia de Amberes y en un taller de París, y en los dos sitios chocó con los profesores por dibujar demasiado deprisa y por negarse a copiar yesos durante meses.",
        },
        {
          forma: "texto",
          texto:
            "Ese detalle contradice de entrada la imagen popular. El hombre al que se recuerda como un intuitivo que pintaba con el estómago empezó estudiando perspectiva con un marco de hilos que se fabricó él mismo, y le dedica a ese armatoste varias cartas con dibujos explicativos incluidos.",
        },
        {
          forma: "texto",
          texto:
            "Los primeros años los pasa en el campo holandés dibujando campesinos, tejedores y comedores de patatas, con una paleta de marrones y grises que no se parece nada a lo que vino después. El color estallará más tarde, en París y en el sur, y lo hará por motivos que él explica por escrito.",
        },
        {
          forma: "texto",
          texto:
            "El cambio ocurre en París, entre 1886 y 1888, viviendo en casa de Theo. Allí ve por primera vez a los impresionistas colgados en la pared, conoce a Pissarro y a Signac, y en dos años pasa del marrón de las patatas a los amarillos que todo el mundo asocia con su nombre.",
        },
        {
          forma: "texto",
          texto:
            "La correspondencia empieza mucho antes de todo esto, en 1872, cuando ambos son adolescentes y trabajan en la misma empresa. Se escriben durante dieciocho años seguidos, con temporadas de una carta cada dos días, y esa continuidad es lo que convierte el conjunto en otra cosa.",
        },
        {
          forma: "texto",
          texto:
            "Vincent escribía casi siempre por la noche, después de pintar todo el día, y a veces mandaba dos cartas seguidas antes de recibir respuesta. Las de Arles llegan a ocupar ocho o diez páginas apretadas, y varias están escritas en francés porque decía que pensaba mejor en ese idioma.",
        },
        {
          forma: "texto",
          texto:
            "La edición crítica moderna, publicada por el museo Van Gogh en 2009, reúne novecientas dos cartas, de las cuales unas ochocientas veinte son suyas y unas seiscientas cincuenta van dirigidas a Theo. Es una de las correspondencias de artista mejor conservadas que existen.",
        },
        {
          forma: "texto",
          texto:
            "También es una de las más desequilibradas, y eso hay que decirlo pronto. De las cartas de Theo a Vincent apenas se conservan unas cuarenta, porque Vincent se mudaba constantemente y no guardaba nada. Escuchamos diez años de conversación con una sola voz encendida.",
        },
        {
          forma: "texto",
          texto:
            "El desequilibrio deforma el retrato de los dos hermanos. Vincent aparece pidiendo, quejándose y prometiendo, mientras que Theo casi no habla; y sabemos por otras fuentes que también él tenía problemas de dinero, una salud frágil y una carrera que dependía de no enfadar a sus jefes.",
        },
        {
          forma: "texto",
          texto:
            "Se pueden leer enteras y gratis en la web del museo, con las cartas escaneadas al lado.",
        },
        {
          forma: "texto",
          texto:
            "Es probablemente el mejor archivo abierto que existe sobre cómo se hace una obra.",
        },
        {
          forma: "texto",
          texto:
            "Con la letra apretada y los dibujos en los márgenes.",
        },
      ],
    },
    {
      titulo: "Ciento cincuenta francos al mes",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "Theo van Gogh era marchante en París, cuatro años menor que Vincent, y tenía un sueldo bueno pero no enorme. Durante diez años le envió dinero a su hermano en giros mensuales, del orden de ciento cincuenta francos, que era aproximadamente lo que ganaba un obrero cualificado.",
        },
        {
          forma: "texto",
          texto:
            "Ese arreglo aparece en casi todas las cartas y es el hilo que las cose. Vincent acusa recibo del giro, explica en qué lo ha gastado, calcula cuánto le queda y anuncia cuánto necesitará el mes siguiente, con la contabilidad detallada de alguien que sabe que está viviendo de otro.",
        },
        {
          forma: "clave",
          rotulo: "La cuenta",
          frase: "Las cartas llevan la contabilidad exacta de una obra: lo que cuesta el óleo, el lienzo, el modelo y el pan de cada semana.",
        },
        {
          forma: "texto",
          texto:
            "Esa contabilidad es lo que hace el libro tan raro dentro de su género. La mayoría de la literatura sobre artistas habla de inspiración y de estilo, y aquí el asunto principal, carta tras carta, es cuánto cuesta producir un cuadro y quién lo va a pagar este mes.",
        },
        {
          forma: "texto",
          texto:
            "Los desgloses son de una concreción que sorprende. Un modelo cuesta más de lo que él come en dos días; el blanco de cinc se acaba antes que ningún otro tubo; un lienzo grande obliga a comer peor ese mes. Pintar aparece siempre como una actividad material con precio, no como una vocación etérea.",
        },
        {
          forma: "texto",
          texto:
            "Hay temporadas documentadas en las que vivió a base de café, pan y tabaco durante días para poder pagar los colores. Lo cuenta sin dramatismo, como quien informa de una decisión de gestión, y a veces le pide a Theo que le adelante el giro porque ha comprado pintura de más.",
        },
        {
          forma: "texto",
          texto:
            "La culpa por ese dinero es el tema emocional del libro entero. Vincent le escribe a Theo que se siente un canalla, que su vida es un fracaso, que le está costando una fortuna y que lo único que puede ofrecerle a cambio son los cuadros, que nadie quiere.",
        },
        {
          forma: "texto",
          texto:
            "Esa culpa tiene además picos concretos y fechados. Cuando Theo se casa y le nace un hijo, Vincent calcula en voz alta lo que su manutención le está quitando a esa familia nueva, y propone repetidamente irse a la legión, buscar un empleo o dejar de pintar. Theo siempre le dice que no.",
        },
        {
          forma: "texto",
          texto:
            "Y de ahí sale un acuerdo que él repite muchas veces y que conviene entender bien. Vincent considera que los cuadros no son suyos, sino de Theo, porque los ha pagado él; se ve a sí mismo como un obrero que entrega su producción al que financia el taller.",
        },
        {
          forma: "texto",
          texto:
            "Cumplía ese trato al pie de la letra y mandaba los lienzos enrollados a París por correo. En el piso de Theo se apilaban por decenas debajo de las camas y encima de los armarios, sin bastidor y sin marco, porque enmarcarlos habría costado un dinero que no tenían.",
        },
        {
          forma: "arte",
          texto:
            "Ese acuerdo tuvo una consecuencia práctica enorme. Al morir los dos hermanos con seis meses de diferencia, las obras no estaban repartidas por Europa en casas de coleccionistas: estaban casi todas juntas, en el piso de Theo en París, en manos de su viuda. Ese detalle contable decidió la historia del arte.",
          arte: "estanteria",
        },
        {
          forma: "texto",
          texto:
            "Es lo contrario de lo que le pasa a casi cualquier pintor de su siglo. Una obra dispersa en cien casas se pierde, se atribuye mal y no se puede exponer junta; una obra concentrada en un piso se puede ordenar, fechar, prestar y convertir en un relato con principio y final.",
        },
        {
          forma: "texto",
          texto:
            "Aquí toca deshacer la cifra más repetida sobre él, la de que solo vendió un cuadro en toda su vida. La venta documentada es La viña roja, comprada en Bruselas en 1890 por la pintora Anna Boch por cuatrocientos francos, unos meses antes de su muerte.",
        },
        {
          forma: "texto",
          texto:
            "Anna Boch merece su línea, porque tampoco fue una compradora casual. Era pintora, coleccionista y hermana de un amigo de Vincent, y compró aquel cuadro por convicción; hoy cuelga en el museo Pushkin de Moscú y es el único que salió de su taller a cambio de un precio de mercado.",
        },
        {
          forma: "texto",
          texto:
            "Pero no fue lo único que salió de su taller. Vendió dibujos a su tío, hizo intercambios de obra con otros pintores, cobró algún encargo pequeño y su marchante hermano colocó algo suelto. La frase correcta sería que casi nadie le compró nada, que ya es bastante triste sin necesidad de redondear.",
        },
        {
          forma: "texto",
          texto:
            "También tuvo reconocimiento crítico antes de morir, aunque muy poco y muy tarde. En enero de 1890, un crítico llamado Albert Aurier publicó un artículo elogioso sobre él en una revista de París, y Vincent le respondió pidiéndole que escribiera mejor sobre Gauguin, que lo necesitaba más.",
        },
        {
          forma: "texto",
          texto:
            "Ese matiz importa porque el dato falso alimenta una moraleja falsa. La versión popular sugiere que el genio incomprendido acaba siendo reconocido, y lo que las cartas enseñan es otra cosa: alguien que produjo durante diez años sin ninguna señal externa de que aquello valiera la pena.",
        },
        {
          forma: "texto",
          texto:
            "Y el reconocimiento posterior tampoco fue automático ni merecido por el mercado. Llegó porque una persona concreta dedicó treinta años a que llegara, mientras que miles de pintores igual de tercos de aquel siglo no tuvieron una cuñada con esa determinación y hoy no los conoce nadie.",
        },
        {
          forma: "texto",
          texto:
            "Hay aquí una conversación directa con La guerra del arte, que está en este catálogo. Pressfield describe al profesional como el que aparece a diario pase lo que pase, y estas cartas son el expediente mejor documentado que existe de exactamente eso, con los recibos incluidos.",
        },
        {
          forma: "texto",
          texto:
            "Pero también le enmiendan la plana en un punto importante. Pressfield escribe como si la constancia bastara y aquí se ve que no: hizo falta además un hermano con sueldo fijo enviando dinero cada mes durante diez años, que es una condición material y no un rasgo de carácter.",
        },
        {
          forma: "texto",
          texto:
            "La diferencia es que aquí no hay ningún final feliz que justifique la disciplina. Van Gogh apareció todos los días durante una década, hizo unas dos mil obras y se murió a los treinta y siete creyendo que había fracasado, sin saber nada de lo que iba a pasar después con sus cuadros.",
        },
        {
          forma: "texto",
          texto:
            "Theo tampoco era solo un cajero. Le mandaba libros, colores nuevos, noticias de lo que se movía en París, y le presentó a Pissarro, a Gauguin y a Toulouse-Lautrec.",
        },
        {
          forma: "texto",
          texto:
            "Y también fue quien no consiguió venderlo, siendo su marchante. Theo trabajaba en una casa que comerciaba con pintura académica, tenía jefes conservadores y arriesgaba su puesto al defender lo que hacía su hermano; en las cartas se le nota el conflicto entre el cariño y el negocio.",
        },
        {
          forma: "texto",
          texto:
            "Sin ese hermano no hay obra, y las cartas lo dicen en cada página.",
        },
      ],
    },
    {
      titulo: "Por qué este rojo va contra este verde",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "En septiembre de 1888, en Arles, Vincent le describe a Theo un cuadro que acaba de terminar de un café nocturno. Y no lo describe contando lo que se ve: lo describe explicando la decisión técnica que ha tomado con el color y qué efecto exacto quiere producir con ella.",
        },
        {
          forma: "texto",
          texto:
            "Escribe que ha intentado expresar las pasiones terribles de la humanidad mediante el rojo y el verde, y que ha buscado un sitio donde uno pueda arruinarse, volverse loco o cometer un crimen. El cuadro no es un desahogo: es un problema planteado y resuelto con dos colores complementarios.",
        },
        {
          forma: "texto",
          texto:
            "En esa misma carta enumera los colores exactos: rojo sangre y amarillo vino, verde suave y verde veronés, y un contraste con azules delicados. Es la descripción de una paleta, no de un estado de ánimo, y la escribió antes de que el cuadro estuviera del todo seco.",
        },
        {
          forma: "clave",
          rotulo: "Lo que desmontan las cartas",
          frase: "No pintaba en trance. Elegía cada color por una razón que sabía explicar por escrito, casi siempre antes de pintarlo.",
        },
        {
          forma: "texto",
          texto:
            "La velocidad con la que pintaba sí es cierta y alimenta la confusión. Terminaba cuadros en una sesión de unas horas, con la pintura muy cargada y sin retoques posteriores, y esa rapidez de ejecución se ha confundido durante un siglo con una falta de premeditación que las cartas desmienten.",
        },
        {
          forma: "texto",
          texto:
            "Con el dormitorio de Arles hace lo mismo y es todavía más claro. Le cuenta que el color tiene que sugerir el descanso y el sueño, que ha suprimido las sombras a propósito para que la habitación parezca plana como una estampa japonesa, y enumera qué color lleva cada objeto y por qué.",
        },
        {
          forma: "texto",
          texto:
            "El interés por la estampa japonesa tampoco es una anécdota decorativa. Van Gogh compró y coleccionó cientos de grabados japoneses en París, copió tres al óleo para estudiarlos y decía que en el sur de Francia buscaba la luz plana y los colores limpios que había visto en ellos.",
        },
        {
          forma: "texto",
          texto:
            "Detrás de todo eso hay lecturas concretas. Van Gogh había estudiado los tratados de color de su época, sobre todo a través de Charles Blanc y de lo que este contaba sobre Delacroix, y aplicaba con conocimiento la ley de los complementarios: cada color se refuerza junto a su opuesto.",
        },
        {
          forma: "texto",
          texto:
            "Llegó a fabricarse una caja con madejas de lana de colores para probar combinaciones antes de pintarlas. Enrollaba dos hilos juntos, miraba cómo se comportaban a distancia y solo entonces preparaba la mezcla en el lienzo. Ese objeto se conserva y es la mejor prueba contra el mito del trance.",
        },
        {
          forma: "arte",
          texto:
            "Las cartas están además llenas de literatura, y no de adorno. Cita a Zola, Dickens, Balzac, Michelet, Carlyle, Shakespeare y Maupassant, discute sus novelas con Theo y compara lo que quiere hacer en pintura con lo que hacen ellos con las clases populares. Leía en holandés, francés e inglés.",
          arte: "lectora",
        },
        {
          forma: "texto",
          texto:
            "También hay un programa artístico explícito y bastante razonado. Quiere pintar campesinos y trabajadores como Millet, con colores modernos, y hacer retratos que dentro de cien años parezcan apariciones; dice que quiere expresar con el color lo que antes se expresaba con la aureola de los santos.",
        },
        {
          forma: "texto",
          texto:
            "Su idea del retrato es de las cosas más modernas que escribió. Dice que no quiere parecerse a la fotografía, que puede copiar la cara mejor que él, sino exagerar el color del pelo y del fondo hasta que el cuadro exprese lo que esa persona es, aunque el parecido salga perjudicado.",
        },
        {
          forma: "texto",
          texto:
            "Sus cartas incluyen cientos de dibujos rápidos a pluma en el margen o en hoja aparte, hechos para que Theo se hiciera una idea del cuadro. Son croquis de trabajo, con anotaciones de color escritas encima, y funcionan como el cuaderno de obra de un taller que nunca tuvo ayudantes.",
        },
        {
          forma: "texto",
          texto:
            "Esos croquis han resultado además decisivos para los conservadores. Muchos pigmentos de sus cuadros han virado con los años, sobre todo los rojos, y las anotaciones de las cartas permiten saber de qué color era originalmente una pared o un mantel que hoy se ve de otro modo.",
        },
        {
          forma: "texto",
          texto:
            "Aquí está la conversación con Modos de ver, que también está en este catálogo. Berger demostraba que una frase colocada junto a un cuadro cambia lo que ves, y usó precisamente un Van Gogh para probarlo; estas cartas son mil quinientas páginas de frases colocadas junto a sus propios cuadros.",
        },
        {
          forma: "texto",
          texto:
            "La diferencia es de quién escribe la frase, y por eso el caso es interesante. Berger denuncia los pies de foto puestos por terceros; aquí el pie de foto lo escribió el pintor, antes de pintar, y sirve para lo contrario: para devolverle al cuadro las razones que tuvo.",
        },
        {
          forma: "texto",
          texto:
            "Y ahí está el peligro de leerlas como manual de instrucciones. Saber que pintó los cuervos sobre el trigal poco antes de morir empuja a ver una premonición en un cuadro que él describió, en esa misma carta, como un intento de expresar tristeza y soledad extremas en un paisaje.",
        },
        {
          forma: "texto",
          texto:
            "El propio artista avisa contra esa lectura sin proponérselo. En las cartas repite que quiere que sus cuadros consuelen, que le gustaría que sirvieran como una música consoladora, y que la salud y el trabajo regular le importan más que cualquier arrebato.",
        },
        {
          forma: "texto",
          texto:
            "Sobre el propio trigal con cuervos escribió que había querido pintar cielos inmensos sobre llanuras y expresar tristeza y soledad extrema, y en la misma carta añadió que esperaba que esos cuadros dijeran también lo saludable y lo fortificante que veía en el campo.",
        },
        {
          forma: "texto",
          texto:
            "Conviene precisar lo que no dice, porque se le atribuye constantemente. No dice en ninguna parte que el sufrimiento mejore la obra, ni que la enfermedad sea el origen de su pintura. Dice justo lo contrario: que cuando está enfermo no puede trabajar, y que trabajar es lo que lo sostiene.",
        },
        {
          forma: "texto",
          texto:
            "Tampoco se presenta nunca como un genio incomprendido por su época. Se compara continuamente con otros pintores para colocarse por debajo, admira a Gauguin y a Millet sin reservas y habla de su propia obra como de un trabajo en curso al que le faltan años de estudio.",
        },
        {
          forma: "texto",
          texto:
            "La otra idea que se le atribuye y no está es la del artista solitario contra el mundo.",
        },
        {
          forma: "texto",
          texto:
            "Escribió cientos de cartas justamente porque no soportaba trabajar sin nadie con quien hablar.",
        },
        {
          forma: "texto",
          texto:
            "Se pasó la vida intentando montar comunidades de pintores que compartieran gastos.",
        },
      ],
    },
    {
      titulo: "La oreja de la que no habla",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "En febrero de 1888, Van Gogh se va a Arles con una idea concreta: alquilar una casa amarilla, montar allí un taller del sur y convivir con otros pintores compartiendo los gastos y los modelos. Pinta girasoles para decorar la habitación del primero que va a llegar.",
        },
        {
          forma: "texto",
          texto:
            "El plan estaba pensado hasta el detalle económico, como todo lo suyo. Varios pintores compartiendo casa gastan menos que cada uno por su lado, pueden pagar modelos entre todos y venden a través de un marchante común, que sería Theo. Sobre el papel era una cooperativa, no un sueño romántico.",
        },
        {
          forma: "texto",
          texto:
            "El que llega es Paul Gauguin, en octubre, con el viaje pagado por Theo a cambio de cuadros. Conviven nueve semanas, pintan a veces el mismo motivo uno al lado del otro y discuten a diario sobre cómo hay que pintar, si del natural o de memoria, cada vez más agriamente.",
        },
        {
          forma: "texto",
          texto:
            "La noche del 23 de diciembre de 1888 termina con Vincent cortándose la oreja izquierda con una navaja y llevando el trozo envuelto a una casa de lencería. Gauguin se marcha de Arles al día siguiente y los dos no volverán a verse nunca, aunque seguirán escribiéndose.",
        },
        {
          forma: "texto",
          texto:
            "Lo que ocurrió esa noche solo se conoce por dos relatos, y ninguno es fiable. Uno es el de la prensa local, breve y confuso; el otro es el de Gauguin, escrito quince años después, cuando ya tenía interés en salir bien parado. Vincent no dejó ninguna versión propia.",
        },
        {
          forma: "texto",
          texto:
            "Durante un siglo se dio por hecho que se cortó solo el lóbulo, y una investigación de 2016 encontró un dibujo del médico que lo atendió, el doctor Rey, que indica que fue casi la oreja entera. La misma investigación identificó a la mujer que la recibió: una criada del prostíbulo, no una prostituta.",
        },
        {
          forma: "clave",
          rotulo: "El silencio del libro",
          frase: "El episodio más famoso de su vida casi no aparece en las cartas. Nunca explicó por qué lo hizo.",
        },
        {
          forma: "texto",
          texto:
            "Ese silencio se repite en todos los momentos difíciles del expediente. No hay cartas sobre la mujer embarazada con la que convivió en La Haya, ni sobre las peleas con su padre, ni sobre los meses en que no tuvo dónde dormir; y en varios de esos huecos falta directamente la correspondencia.",
        },
        {
          forma: "texto",
          texto:
            "Lo que sí escribe, semanas después, es una carta de una serenidad desconcertante. Cuenta que ya está bien, que ha vuelto al trabajo, que espera que Theo no se preocupe demasiado y que le manden más pintura, y trata el asunto como una crisis pasajera que no merece más análisis.",
        },
        {
          forma: "texto",
          texto:
            "Poco después se pinta a sí mismo dos veces con la cabeza vendada, con la pipa en la boca en uno de ellos. Son los cuadros más reproducidos de esa temporada y funcionan como lo que las cartas callan: el relato del episodio existe, pero está en la pintura, no en el texto.",
        },
        {
          forma: "texto",
          texto:
            "Ese es el gran límite de este libro como retrato de su autor. Vincent no es un narrador fiable sobre sí mismo: minimiza sus crisis, tranquiliza a su hermano, calla lo que le avergüenza y deja huecos de semanas justo en los momentos en que más querríamos saber qué pasaba.",
        },
        {
          forma: "texto",
          texto:
            "En mayo de 1889 ingresa voluntariamente en el manicomio de Saint-Rémy, después de que decenas de vecinos de Arles firmaran una petición para que se lo llevaran. Pasa allí un año y pinta unas ciento cincuenta telas, entre ellas La noche estrellada, mirando por la ventana de su cuarto.",
        },
        {
          forma: "texto",
          texto:
            "El detalle de la petición vecinal es de los más duros del expediente. Treinta habitantes de Arles firmaron un escrito pidiendo al alcalde que encerraran al holandés de la casa amarilla, y la policía le precintó la vivienda; el traslado voluntario que vino después fue voluntario a medias.",
        },
        {
          forma: "arte",
          texto:
            "Las cartas de Saint-Rémy son las más útiles para entender su enfermedad, y también las más discretas. Describe ataques que duran días o semanas, durante los cuales no puede pintar ni escribir, y periodos largos de lucidez completa entre uno y otro, en los que trabaja como siempre.",
          arte: "noche",
        },
        {
          forma: "texto",
          texto:
            "Un dato del hospital afina el retrato más que cualquier diagnóstico moderno. Durante una de las crisis intentó tragarse sus propias pinturas, y a partir de entonces le racionaron el material; él escribe pidiendo que le devuelvan los colores porque no poder trabajar le está haciendo más daño que la enfermedad.",
        },
        {
          forma: "texto",
          texto:
            "Sobre qué tenía exactamente no hay acuerdo y conviene decirlo así. Se han propuesto epilepsia del lóbulo temporal, trastorno bipolar, porfiria, intoxicación por absenta y envenenamiento por plomo de las pinturas, y ninguna hipótesis ha ganado; diagnosticar a un muerto por carta es un ejercicio arriesgado.",
        },
        {
          forma: "texto",
          texto:
            "Lo que las cartas sí permiten afirmar es una cosa que contradice el mito. Los cuadros no se pintaron durante las crisis: se pintaron en los intervalos, y él vivía las crisis como una interrupción insoportable de lo único que le importaba, que era poder seguir trabajando.",
        },
        {
          forma: "texto",
          texto:
            "En mayo de 1890 se traslada a Auvers, cerca de París, bajo la vigilancia amable del doctor Gachet. En setenta días pinta unas setenta obras, entre ellas el retrato del médico y los trigales del final, a un ritmo que no había tenido nunca.",
        },
        {
          forma: "texto",
          texto:
            "De Gachet escribe algo que hoy resulta escalofriante y muy suyo. Dice que el médico está tan enfermo y tan nervioso como él, o más, y que un ciego guiando a otro ciego acaban los dos en la zanja. Aun así lo pinta dos veces y le regala uno de los retratos.",
        },
        {
          forma: "texto",
          texto:
            "El 27 de julio vuelve herido de bala a la pensión y muere dos días después, con Theo al lado. La versión del suicidio es la que sostiene el museo Van Gogh; una biografía de 2011 propuso un disparo accidental de unos muchachos, y la mayoría de los especialistas no la aceptó.",
        },
        {
          forma: "texto",
          texto:
            "Los datos duros del caso son pocos y se prestan a discusión. No apareció el arma, no hubo autopsia, la herida estaba en el costado y no en la sien, y no dejó nota; lo que sí consta es que dijo a los gendarmes que se había disparado él y que nadie tenía la culpa.",
        },
        {
          forma: "texto",
          texto:
            "Llevaba en el bolsillo el borrador de una carta a Theo sin enviar.",
        },
        {
          forma: "texto",
          texto:
            "Empieza dándole las gracias por una carta con dinero dentro.",
        },
        {
          forma: "texto",
          texto:
            "Dice que por su trabajo se juega la vida y que su razón se ha hundido a medias.",
        },
      ],
    },
    {
      titulo: "La viuda que inventó a Van Gogh",
      tarjetas: [
        {
          forma: "texto",
          texto:
            "En enero de 1891, seis meses después de Vincent, muere Theo a los treinta y tres años. Su viuda, Johanna van Gogh-Bonger, tiene veintiocho, un bebé de un año llamado Vincent Willem, y una casa llena de cuadros que nadie quiere y de cartas de un cuñado al que apenas trató.",
        },
        {
          forma: "texto",
          texto:
            "La muerte de Theo fue rápida y terrible, y también parte de esta historia. Se derrumbó a las pocas semanas del entierro de su hermano, con un cuadro clínico de origen sifilítico que le costó la razón, y murió en una clínica de Utrecht medio año después de aquel disparo en el trigal.",
        },
        {
          forma: "texto",
          texto:
            "Los amigos de la familia le aconsejan que se deshaga de aquello. Ella se lleva los cuatrocientos y pico cuadros y los dibujos a un pueblo cerca de Ámsterdam, monta una casa de huéspedes para vivir y empieza a leer, ordenar y fechar la correspondencia entera de los dos hermanos.",
        },
        {
          forma: "texto",
          texto:
            "El consejo que recibió lo cuenta ella misma en su diario, y era el sensato. Un crítico amigo le dijo que se quedara con unos cuantos y regalara el resto, porque guardar cuatrocientos cuadros invendibles era una carga para una viuda joven que tenía que sacar adelante a un niño.",
        },
        {
          forma: "clave",
          rotulo: "Quién hizo este libro",
          frase: "No lo hizo Vincent. Lo hizo la mujer que heredó los cuadros que nadie quería y decidió que el mundo iba a leerlos.",
        },
        {
          forma: "texto",
          texto:
            "Durante veinte años presta obra a todas las exposiciones que se lo piden, negocia con marchantes, vende poco y despacio para no saturar el mercado, y va colocando cuadros en museos. Cada préstamo es una decisión suya, y el reconocimiento se construye pieza a pieza.",
        },
        {
          forma: "texto",
          texto:
            "También aprendió sola el oficio de agente. Llevaba un cuaderno con todas las obras, a quién se prestaban y a qué precio se vendían, y organizó en Ámsterdam en 1905 una exposición con casi cuatrocientas cincuenta piezas, la primera que permitió ver la obra entera de golpe.",
        },
        {
          forma: "texto",
          texto:
            "En 1914 publica en tres volúmenes las cartas a Theo, con un prólogo biográfico escrito por ella, y después dedica sus últimos años a traducirlas al inglés. Ese libro es el que ha llegado hasta hoy y el que convirtió a un pintor difícil en un personaje que reconoce todo el mundo.",
        },
        {
          forma: "texto",
          texto:
            "Antes de eso había hecho algo todavía más arriesgado con el mercado. Se negó a vender en bloque la colección a un marchante que quiso comprársela entera, y prefirió ir colocando obras despacio, una a una, entendiendo que la escasez y la presencia continua en exposiciones valían más que el pago rápido.",
        },
        {
          forma: "arte",
          texto:
            "Aquí hay que ser preciso con lo que eso significa. Johanna no era una editora neutral: era la propietaria de las obras, la madre del heredero y la autora del relato, y tenía todos los motivos del mundo para que la historia se contase de una manera concreta y conmovedora.",
          arte: "aprendizaje",
        },
        {
          forma: "texto",
          texto:
            "Conviene decir también lo que no hizo, porque es lo que la separa de un simple albacea interesado. No inventó cartas, no destruyó las que la dejaban mal a ella ni a su marido, y conservó el archivo entero, que es exactamente lo que permitió que un siglo después se pudiera revisar su edición.",
        },
        {
          forma: "texto",
          texto:
            "Seleccionó, ordenó y recortó pasajes, sobre todo los que afectaban a la reputación de la familia y a la vida privada de los dos hermanos. No falsificó nada, pero el libro de 1914 es una versión compuesta, y durante casi un siglo fue la única disponible para casi todos los lectores.",
        },
        {
          forma: "texto",
          texto:
            "Su prólogo biográfico hizo además algo más discutible que cortar frases. Fijó el relato: la infancia difícil, la vocación tardía, el hermano abnegado, la locura y el final trágico, en ese orden y con ese tono, y ese esquema sigue siendo el que repiten las películas cien años después.",
        },
        {
          forma: "texto",
          texto:
            "La edición completa y sin cortes llegó en 2009, después de quince años de trabajo del museo Van Gogh y del instituto Huygens, con las novecientas dos cartas anotadas, fechadas de nuevo y publicadas también en internet en acceso libre y con los facsímiles al lado.",
        },
        {
          forma: "texto",
          texto:
            "Comparar las dos ediciones es el mejor ejercicio que ofrece este libro. Enseña que incluso un texto que parece la voz directa de alguien pasó por manos con intereses, y que la diferencia entre las dos versiones no está en las mentiras, sino en lo que se decidió no imprimir.",
        },
        {
          forma: "texto",
          texto:
            "Y aquí aparece la paradoja del libro. Las cartas desmontan el mito del loco genial, porque muestran a un hombre culto que razonaba cada decisión, y a la vez son lo que hizo posible ese mito, porque contienen una vida tan intensa y tan trágica que se lee mejor que cualquier novela.",
        },
        {
          forma: "texto",
          texto:
            "El cine se encargó del resto y casi siempre eligió la mitad equivocada. Las películas se quedan con la oreja, el manicomio y el disparo, y ninguna dedica una escena a un hombre calculando cuánto blanco de cinc puede comprar este mes con el giro que le acaba de llegar de París.",
        },
        {
          forma: "texto",
          texto:
            "El resultado se ve en las salas de los museos. La gente hace cola ante los girasoles sabiendo lo de la oreja y lo del disparo, y mira los cuadros buscando síntomas, que es exactamente lo contrario de lo que pedían las cartas donde él explicaba por qué había puesto ahí ese amarillo.",
        },
        {
          forma: "texto",
          texto:
            "La magia de crear, también en este catálogo, se pelea justamente con eso. Elizabeth Gilbert sostiene que el modelo del artista atormentado ha hecho más daño que bien, y el caso Van Gogh es el ejemplo que todo el mundo usa, aunque sus propias cartas pidan lo contrario.",
        },
        {
          forma: "texto",
          texto:
            "La manera honesta de leerlas es sin buscar señales del final. Son el cuaderno de trabajo de alguien que pensaba en voz alta sobre el color, el dinero, los libros y su hermano, durante los diez años en que hizo su obra sin ninguna prueba de que sirviera para algo.",
        },
        {
          forma: "texto",
          texto:
            "Leídas así funcionan además como un manual práctico bastante desalentador y muy útil. Enseñan que un oficio se aprende copiando durante años, que producir cuesta dinero contante, que el reconocimiento no depende del mérito y que hace falta alguien que crea en ti antes que nadie.",
        },
        {
          forma: "texto",
          texto:
            "Johanna murió en 1925, con la traducción inglesa a medio terminar.",
        },
        {
          forma: "texto",
          texto:
            "Había pasado treinta y cuatro años trabajando para un cuñado con el que convivió unas pocas semanas.",
        },
        {
          forma: "texto",
          texto:
            "Su hijo la acabó y fundó con la colección el museo que hoy lleva el apellido.",
        },
      ],
    },
  ],
